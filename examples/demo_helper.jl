...
@cstatic show_config_info=false begin
    ...
    if show_config_info
        ...
        CImGui.Separator()
        # CImGui.Text("sizeof(size_t): %d, sizeof(ImDrawIdx): %d, sizeof(ImDrawVert): %d", (int)sizeof(size_t), (int)sizeof(ImDrawIdx), (int)sizeof(ImDrawVert));
        CImGui.Separator()
        ...
        CImGui.Separator()
        # CImGui.Text("style.WindowPadding: %.2f,%.2f", style.WindowPadding.x, style.WindowPadding.y)
        # CImGui.Text("style.WindowBorderSize: %.2f", style.WindowBorderSize)
        # CImGui.Text("style.FramePadding: %.2f,%.2f", style.FramePadding.x, style.FramePadding.y)
        # CImGui.Text("style.FrameRounding: %.2f", style.FrameRounding)
        # CImGui.Text("style.FrameBorderSize: %.2f", style.FrameBorderSize)
        # CImGui.Text("style.ItemSpacing: %.2f,%.2f", style.ItemSpacing.x, style.ItemSpacing.y)
        # CImGui.Text("style.ItemInnerSpacing: %.2f,%.2f", style.ItemInnerSpacing.x, style.ItemInnerSpacing.y)
