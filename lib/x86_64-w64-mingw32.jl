...
function getbitfieldproperty(obj_handle, bitfield_info)
    ...
    u64 = GC.@preserve(obj_handle, unsafe_load(baseptr32))
    if offset + width > 32
        u64 |= GC.@preserve(obj_handle, unsafe_load(baseptr32 + 4)) << 32
    end
...
function getptr(x::Ptr{tm}, f::Symbol)
    ...
    error("Unrecognized field of type `tm`" * ": $(f)")
end

function Base.getproperty(x::Ptr{tm}, f::Symbol)
    f === :tm_sec && return unsafe_load(getptr(x, f))
    f === :tm_min && return unsafe_load(getptr(x, f))
    f === :tm_hour && return unsafe_load(getptr(x, f))
    f === :tm_mday && return unsafe_load(getptr(x, f))
    f === :tm_mon && return unsafe_load(getptr(x, f))
    f === :tm_year && return unsafe_load(getptr(x, f))
    f === :tm_wday && return unsafe_load(getptr(x, f))
    f === :tm_yday && return unsafe_load(getptr(x, f))
    f === :tm_isdst && return unsafe_load(getptr(x, f))
    return getfield(x, f)
end
...
function Base.getproperty(x::tm, f::Symbol)
    ...
    return GC.@preserve(r, getproperty(ptr, f))
end
...
function getptr(x::Ptr{ImVec4}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImVec4}, f::Symbol)
    f === :x && return unsafe_load(getptr(x, f))
    f === :y && return unsafe_load(getptr(x, f))
    f === :z && return unsafe_load(getptr(x, f))
    f === :w && return unsafe_load(getptr(x, f))
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImDrawCmd}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImDrawCmd}, f::Symbol)
    f === :ClipRect && return getptr(x, f)
    f === :TextureId && return unsafe_load(getptr(x, f))
    f === :VtxOffset && return unsafe_load(getptr(x, f))
    f === :IdxOffset && return unsafe_load(getptr(x, f))
    f === :ElemCount && return unsafe_load(getptr(x, f))
    f === :UserCallback && return unsafe_load(getptr(x, f))
    f === :UserCallbackData && return unsafe_load(getptr(x, f))
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImVec2}, f::Symbol)
    f === :x && return Ptr{Cfloat}(x + 0)
    f === :y && return Ptr{Cfloat}(x + 4)
...
function getptr(x::Ptr{ImVector_ImDrawVert}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImVector_ImDrawVert}, f::Symbol)
    f === :Size && return unsafe_load(getptr(x, f))
    f === :Capacity && return unsafe_load(getptr(x, f))
    f === :Data && return unsafe_load(getptr(x, f))
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImFontGlyph}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImFontGlyph}, f::Symbol)
    f === :Colored && return getbitfieldproperty(x, getptr(x, f))
    f === :Visible && return getbitfieldproperty(x, getptr(x, f))
    f === :Codepoint && return getbitfieldproperty(x, getptr(x, f))
    f === :AdvanceX && return unsafe_load(getptr(x, f))
    f === :X0 && return unsafe_load(getptr(x, f))
    f === :Y0 && return unsafe_load(getptr(x, f))
    f === :X1 && return unsafe_load(getptr(x, f))
    f === :Y1 && return unsafe_load(getptr(x, f))
    f === :U0 && return unsafe_load(getptr(x, f))
    f === :V0 && return unsafe_load(getptr(x, f))
    f === :U1 && return unsafe_load(getptr(x, f))
    f === :V1 && return unsafe_load(getptr(x, f))
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImFontConfig}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImFontConfig}, f::Symbol)
    f === :FontData && return unsafe_load(getptr(x, f))
    f === :FontDataSize && return unsafe_load(getptr(x, f))
    f === :FontDataOwnedByAtlas && return unsafe_load(getptr(x, f))
    f === :FontNo && return unsafe_load(getptr(x, f))
    f === :SizePixels && return unsafe_load(getptr(x, f))
    f === :OversampleH && return unsafe_load(getptr(x, f))
    f === :OversampleV && return unsafe_load(getptr(x, f))
    f === :PixelSnapH && return unsafe_load(getptr(x, f))
    f === :GlyphExtraSpacing && return getptr(x, f)
    f === :GlyphOffset && return getptr(x, f)
    f === :GlyphRanges && return unsafe_load(getptr(x, f))
    f === :GlyphMinAdvanceX && return unsafe_load(getptr(x, f))
    f === :GlyphMaxAdvanceX && return unsafe_load(getptr(x, f))
    f === :MergeMode && return unsafe_load(getptr(x, f))
    f === :FontBuilderFlags && return unsafe_load(getptr(x, f))
    f === :RasterizerMultiply && return unsafe_load(getptr(x, f))
    f === :RasterizerDensity && return unsafe_load(getptr(x, f))
    f === :EllipsisChar && return unsafe_load(getptr(x, f))
    f === :Name && return getptr(x, f)
    f === :DstFont && return unsafe_load(getptr(x, f))
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImFontAtlas}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImFontAtlas}, f::Symbol)
    f === :Flags && return unsafe_load(getptr(x, f))
    f === :TexID && return unsafe_load(getptr(x, f))
    f === :TexDesiredWidth && return unsafe_load(getptr(x, f))
    f === :TexGlyphPadding && return unsafe_load(getptr(x, f))
    f === :Locked && return unsafe_load(getptr(x, f))
    f === :UserData && return unsafe_load(getptr(x, f))
    f === :TexReady && return unsafe_load(getptr(x, f))
    f === :TexPixelsUseColors && return unsafe_load(getptr(x, f))
    f === :TexPixelsAlpha8 && return unsafe_load(getptr(x, f))
    f === :TexPixelsRGBA32 && return unsafe_load(getptr(x, f))
    f === :TexWidth && return unsafe_load(getptr(x, f))
    f === :TexHeight && return unsafe_load(getptr(x, f))
    f === :TexUvScale && return getptr(x, f)
    f === :TexUvWhitePixel && return getptr(x, f)
    f === :Fonts && return getptr(x, f)
    f === :CustomRects && return getptr(x, f)
    f === :ConfigData && return getptr(x, f)
    f === :TexUvLines && return getptr(x, f)
    f === :FontBuilderIO && return unsafe_load(getptr(x, f))
    f === :FontBuilderFlags && return unsafe_load(getptr(x, f))
    f === :PackIdMouseCursors && return unsafe_load(getptr(x, f))
    f === :PackIdLines && return unsafe_load(getptr(x, f))
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImDrawList}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImDrawList}, f::Symbol)
    f === :CmdBuffer && return getptr(x, f)
    f === :IdxBuffer && return getptr(x, f)
    f === :VtxBuffer && return getptr(x, f)
    f === :Flags && return unsafe_load(getptr(x, f))
    f === :_VtxCurrentIdx && return unsafe_load(getptr(x, f))
    f === :_Data && return unsafe_load(getptr(x, f))
    f === :_VtxWritePtr && return unsafe_load(getptr(x, f))
    f === :_IdxWritePtr && return unsafe_load(getptr(x, f))
    f === :_Path && return getptr(x, f)
    f === :_CmdHeader && return getptr(x, f)
    f === :_Splitter && return getptr(x, f)
    f === :_ClipRectStack && return getptr(x, f)
    f === :_TextureIdStack && return getptr(x, f)
    f === :_FringeScale && return unsafe_load(getptr(x, f))
    f === :_OwnerName && return unsafe_load(getptr(x, f))
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImGuiViewport}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImGuiViewport}, f::Symbol)
    f === :ID && return unsafe_load(getptr(x, f))
    f === :Flags && return unsafe_load(getptr(x, f))
    f === :Pos && return getptr(x, f)
    f === :Size && return getptr(x, f)
    f === :WorkPos && return getptr(x, f)
    f === :WorkSize && return getptr(x, f)
    f === :DpiScale && return unsafe_load(getptr(x, f))
    f === :ParentViewportId && return unsafe_load(getptr(x, f))
    f === :DrawData && return unsafe_load(getptr(x, f))
    f === :RendererUserData && return unsafe_load(getptr(x, f))
    f === :PlatformUserData && return unsafe_load(getptr(x, f))
    f === :PlatformHandle && return unsafe_load(getptr(x, f))
    f === :PlatformHandleRaw && return unsafe_load(getptr(x, f))
    f === :PlatformWindowCreated && return unsafe_load(getptr(x, f))
    f === :PlatformRequestMove && return unsafe_load(getptr(x, f))
    f === :PlatformRequestResize && return unsafe_load(getptr(x, f))
    f === :PlatformRequestClose && return unsafe_load(getptr(x, f))
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImDrawData}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImDrawData}, f::Symbol)
    f === :Valid && return unsafe_load(getptr(x, f))
    f === :CmdListsCount && return unsafe_load(getptr(x, f))
    f === :TotalIdxCount && return unsafe_load(getptr(x, f))
    f === :TotalVtxCount && return unsafe_load(getptr(x, f))
    f === :CmdLists && return getptr(x, f)
    f === :DisplayPos && return getptr(x, f)
    f === :DisplaySize && return getptr(x, f)
    f === :FramebufferScale && return getptr(x, f)
    f === :OwnerViewport && return unsafe_load(getptr(x, f))
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImGuiKeyData}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImGuiKeyData}, f::Symbol)
    f === :Down && return unsafe_load(getptr(x, f))
    f === :DownDuration && return unsafe_load(getptr(x, f))
    f === :DownDurationPrev && return unsafe_load(getptr(x, f))
    f === :AnalogValue && return unsafe_load(getptr(x, f))
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImGuiIO}, f::Symbol)
    ...
    f === :ConfigInputTrickleEventQueue && return Ptr{Bool}(x + 90)
    f === :ConfigInputTextCursorBlink && return Ptr{Bool}(x + 91)
    f === :ConfigInputTextEnterKeepActive && return Ptr{Bool}(x + 92)
    f === :ConfigDragClickToInputText && return Ptr{Bool}(x + 93)
    f === :ConfigWindowsResizeFromEdges && return Ptr{Bool}(x + 94)
    f === :ConfigWindowsMoveFromTitleBarOnly && return Ptr{Bool}(x + 95)
    f === :ConfigMemoryCompactTimer && return Ptr{Cfloat}(x + 96)
    f === :MouseDoubleClickTime && return Ptr{Cfloat}(x + 100)
    f === :MouseDoubleClickMaxDist && return Ptr{Cfloat}(x + 104)
    f === :MouseDragThreshold && return Ptr{Cfloat}(x + 108)
    f === :KeyRepeatDelay && return Ptr{Cfloat}(x + 112)
    f === :KeyRepeatRate && return Ptr{Cfloat}(x + 116)
    f === :ConfigDebugIsDebuggerPresent && return Ptr{Bool}(x + 120)
    f === :ConfigDebugBeginReturnValueOnce && return Ptr{Bool}(x + 121)
    f === :ConfigDebugBeginReturnValueLoop && return Ptr{Bool}(x + 122)
    f === :ConfigDebugIgnoreFocusLoss && return Ptr{Bool}(x + 123)
    f === :ConfigDebugIniSettings && return Ptr{Bool}(x + 124)
    f === :BackendPlatformName && return Ptr{Ptr{Cchar}}(x + 128)
    f === :BackendRendererName && return Ptr{Ptr{Cchar}}(x + 136)
    f === :BackendPlatformUserData && return Ptr{Ptr{Cvoid}}(x + 144)
    f === :BackendRendererUserData && return Ptr{Ptr{Cvoid}}(x + 152)
    f === :BackendLanguageUserData && return Ptr{Ptr{Cvoid}}(x + 160)
    f === :GetClipboardTextFn && return Ptr{Ptr{Cvoid}}(x + 168)
    f === :SetClipboardTextFn && return Ptr{Ptr{Cvoid}}(x + 176)
    f === :ClipboardUserData && return Ptr{Ptr{Cvoid}}(x + 184)
    f === :SetPlatformImeDataFn && return Ptr{Ptr{Cvoid}}(x + 192)
    f === :PlatformLocaleDecimalPoint && return Ptr{ImWchar}(x + 200)
    f === :WantCaptureMouse && return Ptr{Bool}(x + 202)
    f === :WantCaptureKeyboard && return Ptr{Bool}(x + 203)
    f === :WantTextInput && return Ptr{Bool}(x + 204)
    f === :WantSetMousePos && return Ptr{Bool}(x + 205)
    f === :WantSaveIniSettings && return Ptr{Bool}(x + 206)
    f === :NavActive && return Ptr{Bool}(x + 207)
    f === :NavVisible && return Ptr{Bool}(x + 208)
    f === :Framerate && return Ptr{Cfloat}(x + 212)
    f === :MetricsRenderVertices && return Ptr{Cint}(x + 216)
    f === :MetricsRenderIndices && return Ptr{Cint}(x + 220)
    f === :MetricsRenderWindows && return Ptr{Cint}(x + 224)
    f === :MetricsActiveWindows && return Ptr{Cint}(x + 228)
    f === :MouseDelta && return Ptr{ImVec2}(x + 232)
    f === :Ctx && return Ptr{Ptr{ImGuiContext}}(x + 240)
    f === :MousePos && return Ptr{ImVec2}(x + 248)
    f === :MouseDown && return Ptr{NTuple{5, Bool}}(x + 256)
    f === :MouseWheel && return Ptr{Cfloat}(x + 264)
    f === :MouseWheelH && return Ptr{Cfloat}(x + 268)
    f === :MouseSource && return Ptr{ImGuiMouseSource}(x + 272)
    f === :MouseHoveredViewport && return Ptr{ImGuiID}(x + 276)
    f === :KeyCtrl && return Ptr{Bool}(x + 280)
    f === :KeyShift && return Ptr{Bool}(x + 281)
    f === :KeyAlt && return Ptr{Bool}(x + 282)
    f === :KeySuper && return Ptr{Bool}(x + 283)
    f === :KeyMods && return Ptr{ImGuiKeyChord}(x + 284)
    f === :KeysData && return Ptr{NTuple{154, ImGuiKeyData}}(x + 288)
    f === :WantCaptureMouseUnlessPopupClose && return Ptr{Bool}(x + 2752)
    f === :MousePosPrev && return Ptr{ImVec2}(x + 2756)
    f === :MouseClickedPos && return Ptr{NTuple{5, ImVec2}}(x + 2764)
    f === :MouseClickedTime && return Ptr{NTuple{5, Cdouble}}(x + 2808)
    f === :MouseClicked && return Ptr{NTuple{5, Bool}}(x + 2848)
    f === :MouseDoubleClicked && return Ptr{NTuple{5, Bool}}(x + 2853)
    f === :MouseClickedCount && return Ptr{NTuple{5, ImU16}}(x + 2858)
    f === :MouseClickedLastCount && return Ptr{NTuple{5, ImU16}}(x + 2868)
    f === :MouseReleased && return Ptr{NTuple{5, Bool}}(x + 2878)
    f === :MouseDownOwned && return Ptr{NTuple{5, Bool}}(x + 2883)
    f === :MouseDownOwnedUnlessPopupClose && return Ptr{NTuple{5, Bool}}(x + 2888)
    f === :MouseWheelRequestAxisSwap && return Ptr{Bool}(x + 2893)
    f === :MouseCtrlLeftAsRightClick && return Ptr{Bool}(x + 2894)
    f === :MouseDownDuration && return Ptr{NTuple{5, Cfloat}}(x + 2896)
    f === :MouseDownDurationPrev && return Ptr{NTuple{5, Cfloat}}(x + 2916)
    f === :MouseDragMaxDistanceAbs && return Ptr{NTuple{5, ImVec2}}(x + 2936)
    f === :MouseDragMaxDistanceSqr && return Ptr{NTuple{5, Cfloat}}(x + 2976)
    f === :PenPressure && return Ptr{Cfloat}(x + 2996)
    f === :AppFocusLost && return Ptr{Bool}(x + 3000)
    f === :AppAcceptingEvents && return Ptr{Bool}(x + 3001)
    f === :BackendUsingLegacyKeyArrays && return Ptr{ImS8}(x + 3002)
    f === :BackendUsingLegacyNavInputArray && return Ptr{Bool}(x + 3003)
    f === :InputQueueSurrogate && return Ptr{ImWchar16}(x + 3004)
    f === :InputQueueCharacters && return Ptr{ImVector_ImWchar}(x + 3008)
    error("Unrecognized field of type `ImGuiIO`" * ": $(f)")
end

function Base.getproperty(x::Ptr{ImGuiIO}, f::Symbol)
    f === :ConfigFlags && return unsafe_load(getptr(x, f))
    f === :BackendFlags && return unsafe_load(getptr(x, f))
    f === :DisplaySize && return getptr(x, f)
    f === :DeltaTime && return unsafe_load(getptr(x, f))
    f === :IniSavingRate && return unsafe_load(getptr(x, f))
    f === :IniFilename && return unsafe_load(getptr(x, f))
    f === :LogFilename && return unsafe_load(getptr(x, f))
    f === :UserData && return unsafe_load(getptr(x, f))
    f === :Fonts && return unsafe_load(getptr(x, f))
    f === :FontGlobalScale && return unsafe_load(getptr(x, f))
    f === :FontAllowUserScaling && return unsafe_load(getptr(x, f))
    f === :FontDefault && return unsafe_load(getptr(x, f))
    f === :DisplayFramebufferScale && return getptr(x, f)
    f === :ConfigDockingNoSplit && return unsafe_load(getptr(x, f))
    f === :ConfigDockingWithShift && return unsafe_load(getptr(x, f))
    f === :ConfigDockingAlwaysTabBar && return unsafe_load(getptr(x, f))
    f === :ConfigDockingTransparentPayload && return unsafe_load(getptr(x, f))
    f === :ConfigViewportsNoAutoMerge && return unsafe_load(getptr(x, f))
    f === :ConfigViewportsNoTaskBarIcon && return unsafe_load(getptr(x, f))
    f === :ConfigViewportsNoDecoration && return unsafe_load(getptr(x, f))
    f === :ConfigViewportsNoDefaultParent && return unsafe_load(getptr(x, f))
    f === :MouseDrawCursor && return unsafe_load(getptr(x, f))
    f === :ConfigMacOSXBehaviors && return unsafe_load(getptr(x, f))
    f === :ConfigInputTrickleEventQueue && return unsafe_load(getptr(x, f))
    f === :ConfigInputTextCursorBlink && return unsafe_load(getptr(x, f))
    f === :ConfigInputTextEnterKeepActive && return unsafe_load(getptr(x, f))
    f === :ConfigDragClickToInputText && return unsafe_load(getptr(x, f))
    f === :ConfigWindowsResizeFromEdges && return unsafe_load(getptr(x, f))
    f === :ConfigWindowsMoveFromTitleBarOnly && return unsafe_load(getptr(x, f))
    f === :ConfigMemoryCompactTimer && return unsafe_load(getptr(x, f))
    f === :MouseDoubleClickTime && return unsafe_load(getptr(x, f))
    f === :MouseDoubleClickMaxDist && return unsafe_load(getptr(x, f))
    f === :MouseDragThreshold && return unsafe_load(getptr(x, f))
    f === :KeyRepeatDelay && return unsafe_load(getptr(x, f))
    f === :KeyRepeatRate && return unsafe_load(getptr(x, f))
    f === :ConfigDebugIsDebuggerPresent && return unsafe_load(getptr(x, f))
    f === :ConfigDebugBeginReturnValueOnce && return unsafe_load(getptr(x, f))
    f === :ConfigDebugBeginReturnValueLoop && return unsafe_load(getptr(x, f))
    f === :ConfigDebugIgnoreFocusLoss && return unsafe_load(getptr(x, f))
    f === :ConfigDebugIniSettings && return unsafe_load(getptr(x, f))
    f === :BackendPlatformName && return unsafe_load(getptr(x, f))
    f === :BackendRendererName && return unsafe_load(getptr(x, f))
    f === :BackendPlatformUserData && return unsafe_load(getptr(x, f))
    f === :BackendRendererUserData && return unsafe_load(getptr(x, f))
    f === :BackendLanguageUserData && return unsafe_load(getptr(x, f))
    f === :GetClipboardTextFn && return unsafe_load(getptr(x, f))
    f === :SetClipboardTextFn && return unsafe_load(getptr(x, f))
    f === :ClipboardUserData && return unsafe_load(getptr(x, f))
    f === :SetPlatformImeDataFn && return unsafe_load(getptr(x, f))
    f === :PlatformLocaleDecimalPoint && return unsafe_load(getptr(x, f))
    f === :WantCaptureMouse && return unsafe_load(getptr(x, f))
    f === :WantCaptureKeyboard && return unsafe_load(getptr(x, f))
    f === :WantTextInput && return unsafe_load(getptr(x, f))
    f === :WantSetMousePos && return unsafe_load(getptr(x, f))
    f === :WantSaveIniSettings && return unsafe_load(getptr(x, f))
    f === :NavActive && return unsafe_load(getptr(x, f))
    f === :NavVisible && return unsafe_load(getptr(x, f))
    f === :Framerate && return unsafe_load(getptr(x, f))
    f === :MetricsRenderVertices && return unsafe_load(getptr(x, f))
    f === :MetricsRenderIndices && return unsafe_load(getptr(x, f))
    f === :MetricsRenderWindows && return unsafe_load(getptr(x, f))
    f === :MetricsActiveWindows && return unsafe_load(getptr(x, f))
    f === :MouseDelta && return getptr(x, f)
    f === :Ctx && return unsafe_load(getptr(x, f))
    f === :MousePos && return getptr(x, f)
    f === :MouseDown && return getptr(x, f)
    f === :MouseWheel && return unsafe_load(getptr(x, f))
    f === :MouseWheelH && return unsafe_load(getptr(x, f))
    f === :MouseSource && return unsafe_load(getptr(x, f))
    f === :MouseHoveredViewport && return unsafe_load(getptr(x, f))
    f === :KeyCtrl && return unsafe_load(getptr(x, f))
    f === :KeyShift && return unsafe_load(getptr(x, f))
    f === :KeyAlt && return unsafe_load(getptr(x, f))
    f === :KeySuper && return unsafe_load(getptr(x, f))
    f === :KeyMods && return unsafe_load(getptr(x, f))
    f === :KeysData && return getptr(x, f)
    f === :WantCaptureMouseUnlessPopupClose && return unsafe_load(getptr(x, f))
    f === :MousePosPrev && return getptr(x, f)
    f === :MouseClickedPos && return getptr(x, f)
    f === :MouseClickedTime && return getptr(x, f)
    f === :MouseClicked && return getptr(x, f)
    f === :MouseDoubleClicked && return getptr(x, f)
    f === :MouseClickedCount && return getptr(x, f)
    f === :MouseClickedLastCount && return getptr(x, f)
    f === :MouseReleased && return getptr(x, f)
    f === :MouseDownOwned && return getptr(x, f)
    f === :MouseDownOwnedUnlessPopupClose && return getptr(x, f)
    f === :MouseWheelRequestAxisSwap && return unsafe_load(getptr(x, f))
    f === :MouseCtrlLeftAsRightClick && return unsafe_load(getptr(x, f))
    f === :MouseDownDuration && return getptr(x, f)
    f === :MouseDownDurationPrev && return getptr(x, f)
    f === :MouseDragMaxDistanceAbs && return getptr(x, f)
    f === :MouseDragMaxDistanceSqr && return getptr(x, f)
    f === :PenPressure && return unsafe_load(getptr(x, f))
    f === :AppFocusLost && return unsafe_load(getptr(x, f))
    f === :AppAcceptingEvents && return unsafe_load(getptr(x, f))
    f === :BackendUsingLegacyKeyArrays && return unsafe_load(getptr(x, f))
    f === :BackendUsingLegacyNavInputArray && return unsafe_load(getptr(x, f))
    f === :InputQueueSurrogate && return unsafe_load(getptr(x, f))
    f === :InputQueueCharacters && return getptr(x, f)
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImGuiPlatformMonitor}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImGuiPlatformMonitor}, f::Symbol)
    f === :MainPos && return getptr(x, f)
    f === :MainSize && return getptr(x, f)
    f === :WorkPos && return getptr(x, f)
    f === :WorkSize && return getptr(x, f)
    f === :DpiScale && return unsafe_load(getptr(x, f))
    f === :PlatformHandle && return unsafe_load(getptr(x, f))
...
function getptr(x::Ptr{ImGuiPlatformIO}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImGuiPlatformIO}, f::Symbol)
    f === :Platform_CreateWindow && return unsafe_load(getptr(x, f))
    f === :Platform_DestroyWindow && return unsafe_load(getptr(x, f))
    f === :Platform_ShowWindow && return unsafe_load(getptr(x, f))
    f === :Platform_SetWindowPos && return unsafe_load(getptr(x, f))
    f === :Platform_GetWindowPos && return unsafe_load(getptr(x, f))
    f === :Platform_SetWindowSize && return unsafe_load(getptr(x, f))
    f === :Platform_GetWindowSize && return unsafe_load(getptr(x, f))
    f === :Platform_SetWindowFocus && return unsafe_load(getptr(x, f))
    f === :Platform_GetWindowFocus && return unsafe_load(getptr(x, f))
    f === :Platform_GetWindowMinimized && return unsafe_load(getptr(x, f))
    f === :Platform_SetWindowTitle && return unsafe_load(getptr(x, f))
    f === :Platform_SetWindowAlpha && return unsafe_load(getptr(x, f))
    f === :Platform_UpdateWindow && return unsafe_load(getptr(x, f))
    f === :Platform_RenderWindow && return unsafe_load(getptr(x, f))
    f === :Platform_SwapBuffers && return unsafe_load(getptr(x, f))
    f === :Platform_GetWindowDpiScale && return unsafe_load(getptr(x, f))
    f === :Platform_OnChangedViewport && return unsafe_load(getptr(x, f))
    f === :Platform_CreateVkSurface && return unsafe_load(getptr(x, f))
    f === :Renderer_CreateWindow && return unsafe_load(getptr(x, f))
    f === :Renderer_DestroyWindow && return unsafe_load(getptr(x, f))
    f === :Renderer_SetWindowSize && return unsafe_load(getptr(x, f))
    f === :Renderer_RenderWindow && return unsafe_load(getptr(x, f))
    f === :Renderer_SwapBuffers && return unsafe_load(getptr(x, f))
    f === :Monitors && return getptr(x, f)
    f === :Viewports && return getptr(x, f)
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImGuiStyle}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImGuiStyle}, f::Symbol)
    f === :Alpha && return unsafe_load(getptr(x, f))
    f === :DisabledAlpha && return unsafe_load(getptr(x, f))
    f === :WindowPadding && return getptr(x, f)
    f === :WindowRounding && return unsafe_load(getptr(x, f))
    f === :WindowBorderSize && return unsafe_load(getptr(x, f))
    f === :WindowMinSize && return getptr(x, f)
    f === :WindowTitleAlign && return getptr(x, f)
    f === :WindowMenuButtonPosition && return unsafe_load(getptr(x, f))
    f === :ChildRounding && return unsafe_load(getptr(x, f))
    f === :ChildBorderSize && return unsafe_load(getptr(x, f))
    f === :PopupRounding && return unsafe_load(getptr(x, f))
    f === :PopupBorderSize && return unsafe_load(getptr(x, f))
    f === :FramePadding && return getptr(x, f)
    f === :FrameRounding && return unsafe_load(getptr(x, f))
    f === :FrameBorderSize && return unsafe_load(getptr(x, f))
    f === :ItemSpacing && return getptr(x, f)
    f === :ItemInnerSpacing && return getptr(x, f)
    f === :CellPadding && return getptr(x, f)
    f === :TouchExtraPadding && return getptr(x, f)
    f === :IndentSpacing && return unsafe_load(getptr(x, f))
    f === :ColumnsMinSpacing && return unsafe_load(getptr(x, f))
    f === :ScrollbarSize && return unsafe_load(getptr(x, f))
    f === :ScrollbarRounding && return unsafe_load(getptr(x, f))
    f === :GrabMinSize && return unsafe_load(getptr(x, f))
    f === :GrabRounding && return unsafe_load(getptr(x, f))
    f === :LogSliderDeadzone && return unsafe_load(getptr(x, f))
    f === :TabRounding && return unsafe_load(getptr(x, f))
    f === :TabBorderSize && return unsafe_load(getptr(x, f))
    f === :TabMinWidthForCloseButton && return unsafe_load(getptr(x, f))
    f === :TabBarBorderSize && return unsafe_load(getptr(x, f))
    f === :TableAngledHeadersAngle && return unsafe_load(getptr(x, f))
    f === :TableAngledHeadersTextAlign && return getptr(x, f)
    f === :ColorButtonPosition && return unsafe_load(getptr(x, f))
    f === :ButtonTextAlign && return getptr(x, f)
    f === :SelectableTextAlign && return getptr(x, f)
    f === :SeparatorTextBorderSize && return unsafe_load(getptr(x, f))
    f === :SeparatorTextAlign && return getptr(x, f)
    f === :SeparatorTextPadding && return getptr(x, f)
    f === :DisplayWindowPadding && return getptr(x, f)
    f === :DisplaySafeAreaPadding && return getptr(x, f)
    f === :DockingSeparatorSize && return unsafe_load(getptr(x, f))
    f === :MouseCursorScale && return unsafe_load(getptr(x, f))
    f === :AntiAliasedLines && return unsafe_load(getptr(x, f))
    f === :AntiAliasedLinesUseTex && return unsafe_load(getptr(x, f))
    f === :AntiAliasedFill && return unsafe_load(getptr(x, f))
    f === :CurveTessellationTol && return unsafe_load(getptr(x, f))
    f === :CircleTessellationMaxError && return unsafe_load(getptr(x, f))
    f === :Colors && return getptr(x, f)
    f === :HoverStationaryDelay && return unsafe_load(getptr(x, f))
    f === :HoverDelayShort && return unsafe_load(getptr(x, f))
    f === :HoverDelayNormal && return unsafe_load(getptr(x, f))
    f === :HoverFlagsForTooltipMouse && return unsafe_load(getptr(x, f))
    f === :HoverFlagsForTooltipNav && return unsafe_load(getptr(x, f))
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImGuiInputEvent}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImGuiInputEvent}, f::Symbol)
    f === :Type && return unsafe_load(getptr(x, f))
    f === :Source && return unsafe_load(getptr(x, f))
    f === :EventId && return unsafe_load(getptr(x, f))
    f === :MousePos && return getptr(x, f)
    f === :MouseWheel && return getptr(x, f)
    f === :MouseButton && return getptr(x, f)
    f === :MouseViewport && return getptr(x, f)
    f === :Key && return getptr(x, f)
    f === :Text && return getptr(x, f)
    f === :AppFocused && return getptr(x, f)
    f === :AddedByTestEngine && return unsafe_load(getptr(x, f))
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImGuiStoragePair}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImGuiStoragePair}, f::Symbol)
    f === :key && return unsafe_load(getptr(x, f))
    f === :val_i && return unsafe_load(getptr(x, f))
    f === :val_f && return unsafe_load(getptr(x, f))
    f === :val_p && return unsafe_load(getptr(x, f))
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImGuiDockNode}, f::Symbol)
    f === :ID && return Ptr{ImGuiID}(x + 0)
    ...
    f === :IsVisible && return (Ptr{Bool}(x + 204), 0, 1)
    f === :IsFocused && return (Ptr{Bool}(x + 204), 1, 1)
    f === :IsBgDrawnThisFrame && return (Ptr{Bool}(x + 204), 2, 1)
    f === :HasCloseButton && return (Ptr{Bool}(x + 204), 3, 1)
    f === :HasWindowMenuButton && return (Ptr{Bool}(x + 204), 4, 1)
    f === :HasCentralNodeChild && return (Ptr{Bool}(x + 204), 5, 1)
    f === :WantCloseAll && return (Ptr{Bool}(x + 204), 6, 1)
    f === :WantLockSizeOnce && return (Ptr{Bool}(x + 204), 7, 1)
    f === :WantMouseMove && return (Ptr{Bool}(x + 204), 8, 1)
    f === :WantHiddenTabBarUpdate && return (Ptr{Bool}(x + 204), 9, 1)
    f === :WantHiddenTabBarToggle && return (Ptr{Bool}(x + 204), 10, 1)
    error("Unrecognized field of type `ImGuiDockNode`" * ": $(f)")
end

function Base.getproperty(x::Ptr{ImGuiDockNode}, f::Symbol)
    f === :ID && return unsafe_load(getptr(x, f))
    f === :SharedFlags && return unsafe_load(getptr(x, f))
    f === :LocalFlags && return unsafe_load(getptr(x, f))
    f === :LocalFlagsInWindows && return unsafe_load(getptr(x, f))
    f === :MergedFlags && return unsafe_load(getptr(x, f))
    f === :State && return unsafe_load(getptr(x, f))
    f === :ParentNode && return unsafe_load(getptr(x, f))
    f === :ChildNodes && return getptr(x, f)
    f === :Windows && return getptr(x, f)
    f === :TabBar && return unsafe_load(getptr(x, f))
    f === :Pos && return getptr(x, f)
    f === :Size && return getptr(x, f)
    f === :SizeRef && return getptr(x, f)
    f === :SplitAxis && return unsafe_load(getptr(x, f))
    f === :WindowClass && return getptr(x, f)
    f === :LastBgColor && return unsafe_load(getptr(x, f))
    f === :HostWindow && return unsafe_load(getptr(x, f))
    f === :VisibleWindow && return unsafe_load(getptr(x, f))
    f === :CentralNode && return unsafe_load(getptr(x, f))
    f === :OnlyNodeWithWindows && return unsafe_load(getptr(x, f))
    f === :CountNodeWithWindows && return unsafe_load(getptr(x, f))
    f === :LastFrameAlive && return unsafe_load(getptr(x, f))
    f === :LastFrameActive && return unsafe_load(getptr(x, f))
    f === :LastFrameFocused && return unsafe_load(getptr(x, f))
    f === :LastFocusedNodeId && return unsafe_load(getptr(x, f))
    f === :SelectedTabId && return unsafe_load(getptr(x, f))
    f === :WantCloseTabId && return unsafe_load(getptr(x, f))
    f === :RefViewportId && return unsafe_load(getptr(x, f))
    f === :AuthorityForPos && return getbitfieldproperty(x, getptr(x, f))
    f === :AuthorityForSize && return getbitfieldproperty(x, getptr(x, f))
    f === :AuthorityForViewport && return getbitfieldproperty(x, getptr(x, f))
    f === :IsVisible && return getbitfieldproperty(x, getptr(x, f))
    f === :IsFocused && return getbitfieldproperty(x, getptr(x, f))
    f === :IsBgDrawnThisFrame && return getbitfieldproperty(x, getptr(x, f))
    f === :HasCloseButton && return getbitfieldproperty(x, getptr(x, f))
    f === :HasWindowMenuButton && return getbitfieldproperty(x, getptr(x, f))
    f === :HasCentralNodeChild && return getbitfieldproperty(x, getptr(x, f))
    f === :WantCloseAll && return getbitfieldproperty(x, getptr(x, f))
    f === :WantLockSizeOnce && return getbitfieldproperty(x, getptr(x, f))
    f === :WantMouseMove && return getbitfieldproperty(x, getptr(x, f))
    f === :WantHiddenTabBarUpdate && return getbitfieldproperty(x, getptr(x, f))
    f === :WantHiddenTabBarToggle && return getbitfieldproperty(x, getptr(x, f))
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImGuiWindow}, f::Symbol)
    ...
    f === :DockNode && return Ptr{Ptr{ImGuiDockNode}}(x + 1120)
    f === :DockNodeAsHost && return Ptr{Ptr{ImGuiDockNode}}(x + 1128)
    f === :DockId && return Ptr{ImGuiID}(x + 1136)
    f === :DockTabItemStatusFlags && return Ptr{ImGuiItemStatusFlags}(x + 1140)
    f === :DockTabItemRect && return Ptr{ImRect}(x + 1144)
    error("Unrecognized field of type `ImGuiWindow`" * ": $(f)")
end

function Base.getproperty(x::Ptr{ImGuiWindow}, f::Symbol)
    f === :Ctx && return unsafe_load(getptr(x, f))
    f === :Name && return unsafe_load(getptr(x, f))
    f === :ID && return unsafe_load(getptr(x, f))
    f === :Flags && return unsafe_load(getptr(x, f))
    f === :FlagsPreviousFrame && return unsafe_load(getptr(x, f))
    f === :ChildFlags && return unsafe_load(getptr(x, f))
    f === :WindowClass && return getptr(x, f)
    f === :Viewport && return unsafe_load(getptr(x, f))
    f === :ViewportId && return unsafe_load(getptr(x, f))
    f === :ViewportPos && return getptr(x, f)
    f === :ViewportAllowPlatformMonitorExtend && return unsafe_load(getptr(x, f))
    f === :Pos && return getptr(x, f)
    f === :Size && return getptr(x, f)
    f === :SizeFull && return getptr(x, f)
    f === :ContentSize && return getptr(x, f)
    f === :ContentSizeIdeal && return getptr(x, f)
    f === :ContentSizeExplicit && return getptr(x, f)
    f === :WindowPadding && return getptr(x, f)
    f === :WindowRounding && return unsafe_load(getptr(x, f))
    f === :WindowBorderSize && return unsafe_load(getptr(x, f))
    f === :TitleBarHeight && return unsafe_load(getptr(x, f))
    f === :MenuBarHeight && return unsafe_load(getptr(x, f))
    f === :DecoOuterSizeX1 && return unsafe_load(getptr(x, f))
    f === :DecoOuterSizeY1 && return unsafe_load(getptr(x, f))
    f === :DecoOuterSizeX2 && return unsafe_load(getptr(x, f))
    f === :DecoOuterSizeY2 && return unsafe_load(getptr(x, f))
    f === :DecoInnerSizeX1 && return unsafe_load(getptr(x, f))
    f === :DecoInnerSizeY1 && return unsafe_load(getptr(x, f))
    f === :NameBufLen && return unsafe_load(getptr(x, f))
    f === :MoveId && return unsafe_load(getptr(x, f))
    f === :TabId && return unsafe_load(getptr(x, f))
    f === :ChildId && return unsafe_load(getptr(x, f))
    f === :PopupId && return unsafe_load(getptr(x, f))
    f === :Scroll && return getptr(x, f)
    f === :ScrollMax && return getptr(x, f)
    f === :ScrollTarget && return getptr(x, f)
    f === :ScrollTargetCenterRatio && return getptr(x, f)
    f === :ScrollTargetEdgeSnapDist && return getptr(x, f)
    f === :ScrollbarSizes && return getptr(x, f)
    f === :ScrollbarX && return unsafe_load(getptr(x, f))
    f === :ScrollbarY && return unsafe_load(getptr(x, f))
    f === :ViewportOwned && return unsafe_load(getptr(x, f))
    f === :Active && return unsafe_load(getptr(x, f))
    f === :WasActive && return unsafe_load(getptr(x, f))
    f === :WriteAccessed && return unsafe_load(getptr(x, f))
    f === :Collapsed && return unsafe_load(getptr(x, f))
    f === :WantCollapseToggle && return unsafe_load(getptr(x, f))
    f === :SkipItems && return unsafe_load(getptr(x, f))
    f === :SkipRefresh && return unsafe_load(getptr(x, f))
    f === :Appearing && return unsafe_load(getptr(x, f))
    f === :Hidden && return unsafe_load(getptr(x, f))
    f === :IsFallbackWindow && return unsafe_load(getptr(x, f))
    f === :IsExplicitChild && return unsafe_load(getptr(x, f))
    f === :HasCloseButton && return unsafe_load(getptr(x, f))
    f === :ResizeBorderHovered && return unsafe_load(getptr(x, f))
    f === :ResizeBorderHeld && return unsafe_load(getptr(x, f))
    f === :BeginCount && return unsafe_load(getptr(x, f))
    f === :BeginCountPreviousFrame && return unsafe_load(getptr(x, f))
    f === :BeginOrderWithinParent && return unsafe_load(getptr(x, f))
    f === :BeginOrderWithinContext && return unsafe_load(getptr(x, f))
    f === :FocusOrder && return unsafe_load(getptr(x, f))
    f === :AutoFitFramesX && return unsafe_load(getptr(x, f))
    f === :AutoFitFramesY && return unsafe_load(getptr(x, f))
    f === :AutoFitOnlyGrows && return unsafe_load(getptr(x, f))
    f === :AutoPosLastDirection && return unsafe_load(getptr(x, f))
    f === :HiddenFramesCanSkipItems && return unsafe_load(getptr(x, f))
    f === :HiddenFramesCannotSkipItems && return unsafe_load(getptr(x, f))
    f === :HiddenFramesForRenderOnly && return unsafe_load(getptr(x, f))
    f === :DisableInputsFrames && return unsafe_load(getptr(x, f))
    f === :SetWindowPosAllowFlags && return getbitfieldproperty(x, getptr(x, f))
    f === :SetWindowSizeAllowFlags && return getbitfieldproperty(x, getptr(x, f))
    f === :SetWindowCollapsedAllowFlags && return getbitfieldproperty(x, getptr(x, f))
    f === :SetWindowDockAllowFlags && return getbitfieldproperty(x, getptr(x, f))
    f === :SetWindowPosVal && return getptr(x, f)
    f === :SetWindowPosPivot && return getptr(x, f)
    f === :IDStack && return getptr(x, f)
    f === :DC && return getptr(x, f)
    f === :OuterRectClipped && return getptr(x, f)
    f === :InnerRect && return getptr(x, f)
    f === :InnerClipRect && return getptr(x, f)
    f === :WorkRect && return getptr(x, f)
    f === :ParentWorkRect && return getptr(x, f)
    f === :ClipRect && return getptr(x, f)
    f === :ContentRegionRect && return getptr(x, f)
    f === :HitTestHoleSize && return getptr(x, f)
    f === :HitTestHoleOffset && return getptr(x, f)
    f === :LastFrameActive && return unsafe_load(getptr(x, f))
    f === :LastFrameJustFocused && return unsafe_load(getptr(x, f))
    f === :LastTimeActive && return unsafe_load(getptr(x, f))
    f === :ItemWidthDefault && return unsafe_load(getptr(x, f))
    f === :StateStorage && return getptr(x, f)
    f === :ColumnsStorage && return getptr(x, f)
    f === :FontWindowScale && return unsafe_load(getptr(x, f))
    f === :FontDpiScale && return unsafe_load(getptr(x, f))
    f === :SettingsOffset && return unsafe_load(getptr(x, f))
    f === :DrawList && return unsafe_load(getptr(x, f))
    f === :DrawListInst && return getptr(x, f)
    f === :ParentWindow && return unsafe_load(getptr(x, f))
    f === :ParentWindowInBeginStack && return unsafe_load(getptr(x, f))
    f === :RootWindow && return unsafe_load(getptr(x, f))
    f === :RootWindowPopupTree && return unsafe_load(getptr(x, f))
    f === :RootWindowDockTree && return unsafe_load(getptr(x, f))
    f === :RootWindowForTitleBarHighlight && return unsafe_load(getptr(x, f))
    f === :RootWindowForNav && return unsafe_load(getptr(x, f))
    f === :ParentWindowForFocusRoute && return unsafe_load(getptr(x, f))
    f === :NavLastChildNavWindow && return unsafe_load(getptr(x, f))
    f === :NavLastIds && return getptr(x, f)
    f === :NavRectRel && return getptr(x, f)
    f === :NavPreferredScoringPosRel && return getptr(x, f)
    f === :NavRootFocusScopeId && return unsafe_load(getptr(x, f))
    f === :MemoryDrawListIdxCapacity && return unsafe_load(getptr(x, f))
    f === :MemoryDrawListVtxCapacity && return unsafe_load(getptr(x, f))
    f === :MemoryCompacted && return unsafe_load(getptr(x, f))
    f === :DockIsActive && return getbitfieldproperty(x, getptr(x, f))
    f === :DockNodeIsVisible && return getbitfieldproperty(x, getptr(x, f))
    f === :DockTabIsVisible && return getbitfieldproperty(x, getptr(x, f))
    f === :DockTabWantClose && return getbitfieldproperty(x, getptr(x, f))
    f === :DockOrder && return unsafe_load(getptr(x, f))
    f === :DockStyle && return getptr(x, f)
    f === :DockNode && return unsafe_load(getptr(x, f))
    f === :DockNodeAsHost && return unsafe_load(getptr(x, f))
    f === :DockId && return unsafe_load(getptr(x, f))
    f === :DockTabItemStatusFlags && return unsafe_load(getptr(x, f))
    f === :DockTabItemRect && return getptr(x, f)
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImGuiStyleMod}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImGuiStyleMod}, f::Symbol)
    f === :VarIdx && return unsafe_load(getptr(x, f))
    f === :BackupInt && return getptr(x, f)
    f === :BackupFloat && return getptr(x, f)
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImGuiTableColumn}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImGuiTableColumn}, f::Symbol)
    f === :Flags && return unsafe_load(getptr(x, f))
    f === :WidthGiven && return unsafe_load(getptr(x, f))
    f === :MinX && return unsafe_load(getptr(x, f))
    f === :MaxX && return unsafe_load(getptr(x, f))
    f === :WidthRequest && return unsafe_load(getptr(x, f))
    f === :WidthAuto && return unsafe_load(getptr(x, f))
    f === :StretchWeight && return unsafe_load(getptr(x, f))
    f === :InitStretchWeightOrWidth && return unsafe_load(getptr(x, f))
    f === :ClipRect && return getptr(x, f)
    f === :UserID && return unsafe_load(getptr(x, f))
    f === :WorkMinX && return unsafe_load(getptr(x, f))
    f === :WorkMaxX && return unsafe_load(getptr(x, f))
    f === :ItemWidth && return unsafe_load(getptr(x, f))
    f === :ContentMaxXFrozen && return unsafe_load(getptr(x, f))
    f === :ContentMaxXUnfrozen && return unsafe_load(getptr(x, f))
    f === :ContentMaxXHeadersUsed && return unsafe_load(getptr(x, f))
    f === :ContentMaxXHeadersIdeal && return unsafe_load(getptr(x, f))
    f === :NameOffset && return unsafe_load(getptr(x, f))
    f === :DisplayOrder && return unsafe_load(getptr(x, f))
    f === :IndexWithinEnabledSet && return unsafe_load(getptr(x, f))
    f === :PrevEnabledColumn && return unsafe_load(getptr(x, f))
    f === :NextEnabledColumn && return unsafe_load(getptr(x, f))
    f === :SortOrder && return unsafe_load(getptr(x, f))
    f === :DrawChannelCurrent && return unsafe_load(getptr(x, f))
    f === :DrawChannelFrozen && return unsafe_load(getptr(x, f))
    f === :DrawChannelUnfrozen && return unsafe_load(getptr(x, f))
    f === :IsEnabled && return unsafe_load(getptr(x, f))
    f === :IsUserEnabled && return unsafe_load(getptr(x, f))
    f === :IsUserEnabledNextFrame && return unsafe_load(getptr(x, f))
    f === :IsVisibleX && return unsafe_load(getptr(x, f))
    f === :IsVisibleY && return unsafe_load(getptr(x, f))
    f === :IsRequestOutput && return unsafe_load(getptr(x, f))
    f === :IsSkipItems && return unsafe_load(getptr(x, f))
    f === :IsPreserveWidthAuto && return unsafe_load(getptr(x, f))
    f === :NavLayerCurrent && return unsafe_load(getptr(x, f))
    f === :AutoFitQueue && return unsafe_load(getptr(x, f))
    f === :CannotSkipItemsQueue && return unsafe_load(getptr(x, f))
    f === :SortDirection && return getbitfieldproperty(x, getptr(x, f))
    f === :SortDirectionsAvailCount && return getbitfieldproperty(x, getptr(x, f))
    f === :SortDirectionsAvailMask && return getbitfieldproperty(x, getptr(x, f))
    f === :SortDirectionsAvailList && return unsafe_load(getptr(x, f))
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImGuiTable}, f::Symbol)
    f === :ID && return Ptr{ImGuiID}(x + 0)
...
function Base.getproperty(x::Ptr{ImGuiTable}, f::Symbol)
    f === :ID && return unsafe_load(getptr(x, f))
    f === :Flags && return unsafe_load(getptr(x, f))
    f === :RawData && return unsafe_load(getptr(x, f))
    f === :TempData && return unsafe_load(getptr(x, f))
    f === :Columns && return getptr(x, f)
    f === :DisplayOrderToIndex && return getptr(x, f)
    f === :RowCellData && return getptr(x, f)
    f === :EnabledMaskByDisplayOrder && return unsafe_load(getptr(x, f))
    f === :EnabledMaskByIndex && return unsafe_load(getptr(x, f))
    f === :VisibleMaskByIndex && return unsafe_load(getptr(x, f))
    f === :SettingsLoadedFlags && return unsafe_load(getptr(x, f))
    f === :SettingsOffset && return unsafe_load(getptr(x, f))
    f === :LastFrameActive && return unsafe_load(getptr(x, f))
    f === :ColumnsCount && return unsafe_load(getptr(x, f))
    f === :CurrentRow && return unsafe_load(getptr(x, f))
    f === :CurrentColumn && return unsafe_load(getptr(x, f))
    f === :InstanceCurrent && return unsafe_load(getptr(x, f))
    f === :InstanceInteracted && return unsafe_load(getptr(x, f))
    f === :RowPosY1 && return unsafe_load(getptr(x, f))
    f === :RowPosY2 && return unsafe_load(getptr(x, f))
    f === :RowMinHeight && return unsafe_load(getptr(x, f))
    f === :RowCellPaddingY && return unsafe_load(getptr(x, f))
    f === :RowTextBaseline && return unsafe_load(getptr(x, f))
    f === :RowIndentOffsetX && return unsafe_load(getptr(x, f))
    f === :RowFlags && return getbitfieldproperty(x, getptr(x, f))
    f === :LastRowFlags && return getbitfieldproperty(x, getptr(x, f))
    f === :RowBgColorCounter && return unsafe_load(getptr(x, f))
    f === :RowBgColor && return getptr(x, f)
    f === :BorderColorStrong && return unsafe_load(getptr(x, f))
    f === :BorderColorLight && return unsafe_load(getptr(x, f))
    f === :BorderX1 && return unsafe_load(getptr(x, f))
    f === :BorderX2 && return unsafe_load(getptr(x, f))
    f === :HostIndentX && return unsafe_load(getptr(x, f))
    f === :MinColumnWidth && return unsafe_load(getptr(x, f))
    f === :OuterPaddingX && return unsafe_load(getptr(x, f))
    f === :CellPaddingX && return unsafe_load(getptr(x, f))
    f === :CellSpacingX1 && return unsafe_load(getptr(x, f))
    f === :CellSpacingX2 && return unsafe_load(getptr(x, f))
    f === :InnerWidth && return unsafe_load(getptr(x, f))
    f === :ColumnsGivenWidth && return unsafe_load(getptr(x, f))
    f === :ColumnsAutoFitWidth && return unsafe_load(getptr(x, f))
    f === :ColumnsStretchSumWeights && return unsafe_load(getptr(x, f))
    f === :ResizedColumnNextWidth && return unsafe_load(getptr(x, f))
    f === :ResizeLockMinContentsX2 && return unsafe_load(getptr(x, f))
    f === :RefScale && return unsafe_load(getptr(x, f))
    f === :AngledHeadersHeight && return unsafe_load(getptr(x, f))
    f === :AngledHeadersSlope && return unsafe_load(getptr(x, f))
    f === :OuterRect && return getptr(x, f)
    f === :InnerRect && return getptr(x, f)
    f === :WorkRect && return getptr(x, f)
    f === :InnerClipRect && return getptr(x, f)
    f === :BgClipRect && return getptr(x, f)
    f === :Bg0ClipRectForDrawCmd && return getptr(x, f)
    f === :Bg2ClipRectForDrawCmd && return getptr(x, f)
    f === :HostClipRect && return getptr(x, f)
    f === :HostBackupInnerClipRect && return getptr(x, f)
    f === :OuterWindow && return unsafe_load(getptr(x, f))
    f === :InnerWindow && return unsafe_load(getptr(x, f))
    f === :ColumnsNames && return getptr(x, f)
    f === :DrawSplitter && return unsafe_load(getptr(x, f))
    f === :InstanceDataFirst && return getptr(x, f)
    f === :InstanceDataExtra && return getptr(x, f)
    f === :SortSpecsSingle && return getptr(x, f)
    f === :SortSpecsMulti && return getptr(x, f)
    f === :SortSpecs && return getptr(x, f)
    f === :SortSpecsCount && return unsafe_load(getptr(x, f))
    f === :ColumnsEnabledCount && return unsafe_load(getptr(x, f))
    f === :ColumnsEnabledFixedCount && return unsafe_load(getptr(x, f))
    f === :DeclColumnsCount && return unsafe_load(getptr(x, f))
    f === :AngledHeadersCount && return unsafe_load(getptr(x, f))
    f === :HoveredColumnBody && return unsafe_load(getptr(x, f))
    f === :HoveredColumnBorder && return unsafe_load(getptr(x, f))
    f === :HighlightColumnHeader && return unsafe_load(getptr(x, f))
    f === :AutoFitSingleColumn && return unsafe_load(getptr(x, f))
    f === :ResizedColumn && return unsafe_load(getptr(x, f))
    f === :LastResizedColumn && return unsafe_load(getptr(x, f))
    f === :HeldHeaderColumn && return unsafe_load(getptr(x, f))
    f === :ReorderColumn && return unsafe_load(getptr(x, f))
    f === :ReorderColumnDir && return unsafe_load(getptr(x, f))
    f === :LeftMostEnabledColumn && return unsafe_load(getptr(x, f))
    f === :RightMostEnabledColumn && return unsafe_load(getptr(x, f))
    f === :LeftMostStretchedColumn && return unsafe_load(getptr(x, f))
    f === :RightMostStretchedColumn && return unsafe_load(getptr(x, f))
    f === :ContextPopupColumn && return unsafe_load(getptr(x, f))
    f === :FreezeRowsRequest && return unsafe_load(getptr(x, f))
    f === :FreezeRowsCount && return unsafe_load(getptr(x, f))
    f === :FreezeColumnsRequest && return unsafe_load(getptr(x, f))
    f === :FreezeColumnsCount && return unsafe_load(getptr(x, f))
    f === :RowCellDataCurrent && return unsafe_load(getptr(x, f))
    f === :DummyDrawChannel && return unsafe_load(getptr(x, f))
    f === :Bg2DrawChannelCurrent && return unsafe_load(getptr(x, f))
    f === :Bg2DrawChannelUnfrozen && return unsafe_load(getptr(x, f))
    f === :IsLayoutLocked && return unsafe_load(getptr(x, f))
    f === :IsInsideRow && return unsafe_load(getptr(x, f))
    f === :IsInitializing && return unsafe_load(getptr(x, f))
    f === :IsSortSpecsDirty && return unsafe_load(getptr(x, f))
    f === :IsUsingHeaders && return unsafe_load(getptr(x, f))
    f === :IsContextPopupOpen && return unsafe_load(getptr(x, f))
    f === :DisableDefaultContextMenu && return unsafe_load(getptr(x, f))
    f === :IsSettingsRequestLoad && return unsafe_load(getptr(x, f))
    f === :IsSettingsDirty && return unsafe_load(getptr(x, f))
    f === :IsDefaultDisplayOrder && return unsafe_load(getptr(x, f))
    f === :IsResetAllRequest && return unsafe_load(getptr(x, f))
    f === :IsResetDisplayOrderRequest && return unsafe_load(getptr(x, f))
    f === :IsUnfrozenRows && return unsafe_load(getptr(x, f))
    f === :IsDefaultSizingPolicy && return unsafe_load(getptr(x, f))
    f === :IsActiveIdAliveBeforeTable && return unsafe_load(getptr(x, f))
    f === :IsActiveIdInTable && return unsafe_load(getptr(x, f))
    f === :HasScrollbarYCurr && return unsafe_load(getptr(x, f))
    f === :HasScrollbarYPrev && return unsafe_load(getptr(x, f))
    f === :MemoryCompacted && return unsafe_load(getptr(x, f))
    f === :HostSkipItems && return unsafe_load(getptr(x, f))
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImGuiStackLevelInfo}, f::Symbol)
    f === :ID && return Ptr{ImGuiID}(x + 0)
    f === :QueryFrameCount && return Ptr{ImS8}(x + 4)
    f === :QuerySuccess && return Ptr{Bool}(x + 5)
    f === :DataType && return (Ptr{ImGuiDataType}(x + 8), 0, 8)
    f === :Desc && return Ptr{NTuple{57, Cchar}}(x + 12)
    error("Unrecognized field of type `ImGuiStackLevelInfo`" * ": $(f)")
end

function Base.getproperty(x::Ptr{ImGuiStackLevelInfo}, f::Symbol)
    f === :ID && return unsafe_load(getptr(x, f))
    f === :QueryFrameCount && return unsafe_load(getptr(x, f))
    f === :QuerySuccess && return unsafe_load(getptr(x, f))
    f === :DataType && return getbitfieldproperty(x, getptr(x, f))
    f === :Desc && return getptr(x, f)
    return getfield(x, f)
end
...
struct ImGuiContext
    data::NTuple{14192, UInt8}
end

function getptr(x::Ptr{ImGuiContext}, f::Symbol)
    f === :Initialized && return Ptr{Bool}(x + 0)
    f === :FontAtlasOwnedByContext && return Ptr{Bool}(x + 1)
    f === :IO && return Ptr{ImGuiIO}(x + 8)
    f === :PlatformIO && return Ptr{ImGuiPlatformIO}(x + 3032)
    f === :Style && return Ptr{ImGuiStyle}(x + 3248)
    f === :ConfigFlagsCurrFrame && return Ptr{ImGuiConfigFlags}(x + 4388)
    f === :ConfigFlagsLastFrame && return Ptr{ImGuiConfigFlags}(x + 4392)
    f === :Font && return Ptr{Ptr{ImFont}}(x + 4400)
    f === :FontSize && return Ptr{Cfloat}(x + 4408)
    f === :FontBaseSize && return Ptr{Cfloat}(x + 4412)
    f === :CurrentDpiScale && return Ptr{Cfloat}(x + 4416)
    f === :DrawListSharedData && return Ptr{ImDrawListSharedData}(x + 4424)
    f === :Time && return Ptr{Cdouble}(x + 4952)
    f === :FrameCount && return Ptr{Cint}(x + 4960)
    f === :FrameCountEnded && return Ptr{Cint}(x + 4964)
    f === :FrameCountPlatformEnded && return Ptr{Cint}(x + 4968)
    f === :FrameCountRendered && return Ptr{Cint}(x + 4972)
    f === :WithinFrameScope && return Ptr{Bool}(x + 4976)
    f === :WithinFrameScopeWithImplicitWindow && return Ptr{Bool}(x + 4977)
    f === :WithinEndChild && return Ptr{Bool}(x + 4978)
    f === :GcCompactAll && return Ptr{Bool}(x + 4979)
    f === :TestEngineHookItems && return Ptr{Bool}(x + 4980)
    f === :TestEngine && return Ptr{Ptr{Cvoid}}(x + 4984)
    f === :InputEventsQueue && return Ptr{ImVector_ImGuiInputEvent}(x + 4992)
    f === :InputEventsTrail && return Ptr{ImVector_ImGuiInputEvent}(x + 5008)
    f === :InputEventsNextMouseSource && return Ptr{ImGuiMouseSource}(x + 5024)
    f === :InputEventsNextEventId && return Ptr{ImU32}(x + 5028)
    f === :Windows && return Ptr{ImVector_ImGuiWindowPtr}(x + 5032)
    f === :WindowsFocusOrder && return Ptr{ImVector_ImGuiWindowPtr}(x + 5048)
    f === :WindowsTempSortBuffer && return Ptr{ImVector_ImGuiWindowPtr}(x + 5064)
    f === :CurrentWindowStack && return Ptr{ImVector_ImGuiWindowStackData}(x + 5080)
    f === :WindowsById && return Ptr{ImGuiStorage}(x + 5096)
    f === :WindowsActiveCount && return Ptr{Cint}(x + 5112)
    f === :WindowsHoverPadding && return Ptr{ImVec2}(x + 5116)
    f === :DebugBreakInWindow && return Ptr{ImGuiID}(x + 5124)
    f === :CurrentWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5128)
    f === :HoveredWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5136)
    f === :HoveredWindowUnderMovingWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5144)
    f === :MovingWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5152)
    f === :WheelingWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5160)
    f === :WheelingWindowRefMousePos && return Ptr{ImVec2}(x + 5168)
    f === :WheelingWindowStartFrame && return Ptr{Cint}(x + 5176)
    f === :WheelingWindowScrolledFrame && return Ptr{Cint}(x + 5180)
    f === :WheelingWindowReleaseTimer && return Ptr{Cfloat}(x + 5184)
    f === :WheelingWindowWheelRemainder && return Ptr{ImVec2}(x + 5188)
    f === :WheelingAxisAvg && return Ptr{ImVec2}(x + 5196)
    f === :DebugHookIdInfo && return Ptr{ImGuiID}(x + 5204)
    f === :HoveredId && return Ptr{ImGuiID}(x + 5208)
    f === :HoveredIdPreviousFrame && return Ptr{ImGuiID}(x + 5212)
    f === :HoveredIdTimer && return Ptr{Cfloat}(x + 5216)
    f === :HoveredIdNotActiveTimer && return Ptr{Cfloat}(x + 5220)
    f === :HoveredIdAllowOverlap && return Ptr{Bool}(x + 5224)
    f === :HoveredIdDisabled && return Ptr{Bool}(x + 5225)
    f === :ItemUnclipByLog && return Ptr{Bool}(x + 5226)
    f === :ActiveId && return Ptr{ImGuiID}(x + 5228)
    f === :ActiveIdIsAlive && return Ptr{ImGuiID}(x + 5232)
    f === :ActiveIdTimer && return Ptr{Cfloat}(x + 5236)
    f === :ActiveIdIsJustActivated && return Ptr{Bool}(x + 5240)
    f === :ActiveIdAllowOverlap && return Ptr{Bool}(x + 5241)
    f === :ActiveIdNoClearOnFocusLoss && return Ptr{Bool}(x + 5242)
    f === :ActiveIdHasBeenPressedBefore && return Ptr{Bool}(x + 5243)
    f === :ActiveIdHasBeenEditedBefore && return Ptr{Bool}(x + 5244)
    f === :ActiveIdHasBeenEditedThisFrame && return Ptr{Bool}(x + 5245)
    f === :ActiveIdFromShortcut && return Ptr{Bool}(x + 5246)
    f === :ActiveIdMouseButton && return (Ptr{Cint}(x + 5248), 0, 8)
    f === :ActiveIdClickOffset && return Ptr{ImVec2}(x + 5252)
    f === :ActiveIdWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5264)
    f === :ActiveIdSource && return Ptr{ImGuiInputSource}(x + 5272)
    f === :ActiveIdPreviousFrame && return Ptr{ImGuiID}(x + 5276)
    f === :ActiveIdPreviousFrameIsAlive && return Ptr{Bool}(x + 5280)
    f === :ActiveIdPreviousFrameHasBeenEditedBefore && return Ptr{Bool}(x + 5281)
    f === :ActiveIdPreviousFrameWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5288)
    f === :LastActiveId && return Ptr{ImGuiID}(x + 5296)
    f === :LastActiveIdTimer && return Ptr{Cfloat}(x + 5300)
    f === :LastKeyModsChangeTime && return Ptr{Cdouble}(x + 5304)
    f === :LastKeyModsChangeFromNoneTime && return Ptr{Cdouble}(x + 5312)
    f === :LastKeyboardKeyPressTime && return Ptr{Cdouble}(x + 5320)
    f === :KeysMayBeCharInput && return Ptr{ImBitArrayForNamedKeys}(x + 5328)
    f === :KeysOwnerData && return Ptr{NTuple{154, ImGuiKeyOwnerData}}(x + 5348)
    f === :KeysRoutingTable && return Ptr{ImGuiKeyRoutingTable}(x + 7200)
    f === :ActiveIdUsingNavDirMask && return Ptr{ImU32}(x + 7544)
    f === :ActiveIdUsingAllKeyboardKeys && return Ptr{Bool}(x + 7548)
    f === :DebugBreakInShortcutRouting && return Ptr{ImGuiKeyChord}(x + 7552)
    f === :CurrentFocusScopeId && return Ptr{ImGuiID}(x + 7556)
    f === :CurrentItemFlags && return Ptr{ImGuiItemFlags}(x + 7560)
    f === :DebugLocateId && return Ptr{ImGuiID}(x + 7564)
    f === :NextItemData && return Ptr{ImGuiNextItemData}(x + 7568)
    f === :LastItemData && return Ptr{ImGuiLastItemData}(x + 7608)
    f === :NextWindowData && return Ptr{ImGuiNextWindowData}(x + 7688)
    f === :DebugShowGroupRects && return Ptr{Bool}(x + 7848)
    f === :DebugFlashStyleColorIdx && return Ptr{ImGuiCol}(x + 7852)
    f === :ColorStack && return Ptr{ImVector_ImGuiColorMod}(x + 7856)
    f === :StyleVarStack && return Ptr{ImVector_ImGuiStyleMod}(x + 7872)
    f === :FontStack && return Ptr{ImVector_ImFontPtr}(x + 7888)
    f === :FocusScopeStack && return Ptr{ImVector_ImGuiFocusScopeData}(x + 7904)
    f === :ItemFlagsStack && return Ptr{ImVector_ImGuiItemFlags}(x + 7920)
    f === :GroupStack && return Ptr{ImVector_ImGuiGroupData}(x + 7936)
    f === :OpenPopupStack && return Ptr{ImVector_ImGuiPopupData}(x + 7952)
    f === :BeginPopupStack && return Ptr{ImVector_ImGuiPopupData}(x + 7968)
    f === :NavTreeNodeStack && return Ptr{ImVector_ImGuiNavTreeNodeData}(x + 7984)
    f === :Viewports && return Ptr{ImVector_ImGuiViewportPPtr}(x + 8000)
    f === :CurrentViewport && return Ptr{Ptr{ImGuiViewportP}}(x + 8016)
    f === :MouseViewport && return Ptr{Ptr{ImGuiViewportP}}(x + 8024)
    f === :MouseLastHoveredViewport && return Ptr{Ptr{ImGuiViewportP}}(x + 8032)
    f === :PlatformLastFocusedViewportId && return Ptr{ImGuiID}(x + 8040)
    f === :FallbackMonitor && return Ptr{ImGuiPlatformMonitor}(x + 8048)
    f === :PlatformMonitorsFullWorkRect && return Ptr{ImRect}(x + 8096)
    f === :ViewportCreatedCount && return Ptr{Cint}(x + 8112)
    f === :PlatformWindowsCreatedCount && return Ptr{Cint}(x + 8116)
    f === :ViewportFocusedStampCount && return Ptr{Cint}(x + 8120)
    f === :NavWindow && return Ptr{Ptr{ImGuiWindow}}(x + 8128)
    f === :NavId && return Ptr{ImGuiID}(x + 8136)
    f === :NavFocusScopeId && return Ptr{ImGuiID}(x + 8140)
    f === :NavActivateId && return Ptr{ImGuiID}(x + 8144)
    f === :NavActivateDownId && return Ptr{ImGuiID}(x + 8148)
    f === :NavActivatePressedId && return Ptr{ImGuiID}(x + 8152)
    f === :NavActivateFlags && return Ptr{ImGuiActivateFlags}(x + 8156)
    f === :NavFocusRoute && return Ptr{ImVector_ImGuiFocusScopeData}(x + 8160)
    f === :NavHighlightActivatedId && return Ptr{ImGuiID}(x + 8176)
    f === :NavHighlightActivatedTimer && return Ptr{Cfloat}(x + 8180)
    f === :NavJustMovedToId && return Ptr{ImGuiID}(x + 8184)
    f === :NavJustMovedToFocusScopeId && return Ptr{ImGuiID}(x + 8188)
    f === :NavJustMovedToKeyMods && return Ptr{ImGuiKeyChord}(x + 8192)
    f === :NavNextActivateId && return Ptr{ImGuiID}(x + 8196)
    f === :NavNextActivateFlags && return Ptr{ImGuiActivateFlags}(x + 8200)
    f === :NavInputSource && return Ptr{ImGuiInputSource}(x + 8204)
    f === :NavLayer && return Ptr{ImGuiNavLayer}(x + 8208)
    f === :NavLastValidSelectionUserData && return Ptr{ImGuiSelectionUserData}(x + 8216)
    f === :NavIdIsAlive && return Ptr{Bool}(x + 8224)
    f === :NavMousePosDirty && return Ptr{Bool}(x + 8225)
    f === :NavDisableHighlight && return Ptr{Bool}(x + 8226)
    f === :NavDisableMouseHover && return Ptr{Bool}(x + 8227)
    f === :NavAnyRequest && return Ptr{Bool}(x + 8228)
    f === :NavInitRequest && return Ptr{Bool}(x + 8229)
    f === :NavInitRequestFromMove && return Ptr{Bool}(x + 8230)
    f === :NavInitResult && return Ptr{ImGuiNavItemData}(x + 8232)
    f === :NavMoveSubmitted && return Ptr{Bool}(x + 8288)
    f === :NavMoveScoringItems && return Ptr{Bool}(x + 8289)
    f === :NavMoveForwardToNextFrame && return Ptr{Bool}(x + 8290)
    f === :NavMoveFlags && return Ptr{ImGuiNavMoveFlags}(x + 8292)
    f === :NavMoveScrollFlags && return Ptr{ImGuiScrollFlags}(x + 8296)
    f === :NavMoveKeyMods && return Ptr{ImGuiKeyChord}(x + 8300)
    f === :NavMoveDir && return Ptr{ImGuiDir}(x + 8304)
    f === :NavMoveDirForDebug && return Ptr{ImGuiDir}(x + 8308)
    f === :NavMoveClipDir && return Ptr{ImGuiDir}(x + 8312)
    f === :NavScoringRect && return Ptr{ImRect}(x + 8316)
    f === :NavScoringNoClipRect && return Ptr{ImRect}(x + 8332)
    f === :NavScoringDebugCount && return Ptr{Cint}(x + 8348)
    f === :NavTabbingDir && return Ptr{Cint}(x + 8352)
    f === :NavTabbingCounter && return Ptr{Cint}(x + 8356)
    f === :NavMoveResultLocal && return Ptr{ImGuiNavItemData}(x + 8360)
    f === :NavMoveResultLocalVisible && return Ptr{ImGuiNavItemData}(x + 8416)
    f === :NavMoveResultOther && return Ptr{ImGuiNavItemData}(x + 8472)
    f === :NavTabbingResultFirst && return Ptr{ImGuiNavItemData}(x + 8528)
    f === :ConfigNavWindowingKeyNext && return Ptr{ImGuiKeyChord}(x + 8584)
    f === :ConfigNavWindowingKeyPrev && return Ptr{ImGuiKeyChord}(x + 8588)
    f === :NavWindowingTarget && return Ptr{Ptr{ImGuiWindow}}(x + 8592)
    f === :NavWindowingTargetAnim && return Ptr{Ptr{ImGuiWindow}}(x + 8600)
    f === :NavWindowingListWindow && return Ptr{Ptr{ImGuiWindow}}(x + 8608)
    f === :NavWindowingTimer && return Ptr{Cfloat}(x + 8616)
    f === :NavWindowingHighlightAlpha && return Ptr{Cfloat}(x + 8620)
    f === :NavWindowingToggleLayer && return Ptr{Bool}(x + 8624)
    f === :NavWindowingToggleKey && return Ptr{ImGuiKey}(x + 8628)
    f === :NavWindowingAccumDeltaPos && return Ptr{ImVec2}(x + 8632)
    f === :NavWindowingAccumDeltaSize && return Ptr{ImVec2}(x + 8640)
    f === :DimBgRatio && return Ptr{Cfloat}(x + 8648)
    f === :DragDropActive && return Ptr{Bool}(x + 8652)
    f === :DragDropWithinSource && return Ptr{Bool}(x + 8653)
    f === :DragDropWithinTarget && return Ptr{Bool}(x + 8654)
    f === :DragDropSourceFlags && return Ptr{ImGuiDragDropFlags}(x + 8656)
    f === :DragDropSourceFrameCount && return Ptr{Cint}(x + 8660)
    f === :DragDropMouseButton && return Ptr{Cint}(x + 8664)
    f === :DragDropPayload && return Ptr{ImGuiPayload}(x + 8672)
    f === :DragDropTargetRect && return Ptr{ImRect}(x + 8736)
    f === :DragDropTargetClipRect && return Ptr{ImRect}(x + 8752)
    f === :DragDropTargetId && return Ptr{ImGuiID}(x + 8768)
    f === :DragDropAcceptFlags && return Ptr{ImGuiDragDropFlags}(x + 8772)
    f === :DragDropAcceptIdCurrRectSurface && return Ptr{Cfloat}(x + 8776)
    f === :DragDropAcceptIdCurr && return Ptr{ImGuiID}(x + 8780)
    f === :DragDropAcceptIdPrev && return Ptr{ImGuiID}(x + 8784)
    f === :DragDropAcceptFrameCount && return Ptr{Cint}(x + 8788)
    f === :DragDropHoldJustPressedId && return Ptr{ImGuiID}(x + 8792)
    f === :DragDropPayloadBufHeap && return Ptr{ImVector_unsigned_char}(x + 8800)
    f === :DragDropPayloadBufLocal && return Ptr{NTuple{16, Cuchar}}(x + 8816)
    f === :ClipperTempDataStacked && return Ptr{Cint}(x + 8832)
    f === :ClipperTempData && return Ptr{ImVector_ImGuiListClipperData}(x + 8840)
    f === :CurrentTable && return Ptr{Ptr{ImGuiTable}}(x + 8856)
    f === :DebugBreakInTable && return Ptr{ImGuiID}(x + 8864)
    f === :TablesTempDataStacked && return Ptr{Cint}(x + 8868)
    f === :TablesTempData && return Ptr{ImVector_ImGuiTableTempData}(x + 8872)
    f === :Tables && return Ptr{ImPool_ImGuiTable}(x + 8888)
    f === :TablesLastTimeActive && return Ptr{ImVector_float}(x + 8928)
    f === :DrawChannelsTempMergeBuffer && return Ptr{ImVector_ImDrawChannel}(x + 8944)
    f === :CurrentTabBar && return Ptr{Ptr{ImGuiTabBar}}(x + 8960)
    f === :TabBars && return Ptr{ImPool_ImGuiTabBar}(x + 8968)
    f === :CurrentTabBarStack && return Ptr{ImVector_ImGuiPtrOrIndex}(x + 9008)
    f === :ShrinkWidthBuffer && return Ptr{ImVector_ImGuiShrinkWidthItem}(x + 9024)
    f === :HoverItemDelayId && return Ptr{ImGuiID}(x + 9040)
    f === :HoverItemDelayIdPreviousFrame && return Ptr{ImGuiID}(x + 9044)
    f === :HoverItemDelayTimer && return Ptr{Cfloat}(x + 9048)
    f === :HoverItemDelayClearTimer && return Ptr{Cfloat}(x + 9052)
    f === :HoverItemUnlockedStationaryId && return Ptr{ImGuiID}(x + 9056)
    f === :HoverWindowUnlockedStationaryId && return Ptr{ImGuiID}(x + 9060)
    f === :MouseCursor && return Ptr{ImGuiMouseCursor}(x + 9064)
    f === :MouseStationaryTimer && return Ptr{Cfloat}(x + 9068)
    f === :MouseLastValidPos && return Ptr{ImVec2}(x + 9072)
    f === :InputTextState && return Ptr{ImGuiInputTextState}(x + 9080)
    f === :InputTextDeactivatedState && return Ptr{ImGuiInputTextDeactivatedState}(x + 12816)
    f === :InputTextPasswordFont && return Ptr{ImFont}(x + 12840)
    f === :TempInputId && return Ptr{ImGuiID}(x + 12960)
    f === :DataTypeZeroValue && return Ptr{ImGuiDataTypeStorage}(x + 12964)
    f === :BeginMenuDepth && return Ptr{Cint}(x + 12972)
    f === :BeginComboDepth && return Ptr{Cint}(x + 12976)
    f === :ColorEditOptions && return Ptr{ImGuiColorEditFlags}(x + 12980)
    f === :ColorEditCurrentID && return Ptr{ImGuiID}(x + 12984)
    f === :ColorEditSavedID && return Ptr{ImGuiID}(x + 12988)
    f === :ColorEditSavedHue && return Ptr{Cfloat}(x + 12992)
    f === :ColorEditSavedSat && return Ptr{Cfloat}(x + 12996)
    f === :ColorEditSavedColor && return Ptr{ImU32}(x + 13000)
    f === :ColorPickerRef && return Ptr{ImVec4}(x + 13004)
    f === :ComboPreviewData && return Ptr{ImGuiComboPreviewData}(x + 13020)
    f === :WindowResizeBorderExpectedRect && return Ptr{ImRect}(x + 13068)
    f === :WindowResizeRelativeMode && return Ptr{Bool}(x + 13084)
    f === :ScrollbarSeekMode && return Ptr{Cshort}(x + 13086)
    f === :ScrollbarClickDeltaToGrabCenter && return Ptr{Cfloat}(x + 13088)
    f === :SliderGrabClickOffset && return Ptr{Cfloat}(x + 13092)
    f === :SliderCurrentAccum && return Ptr{Cfloat}(x + 13096)
    f === :SliderCurrentAccumDirty && return Ptr{Bool}(x + 13100)
    f === :DragCurrentAccumDirty && return Ptr{Bool}(x + 13101)
    f === :DragCurrentAccum && return Ptr{Cfloat}(x + 13104)
    f === :DragSpeedDefaultRatio && return Ptr{Cfloat}(x + 13108)
    f === :DisabledAlphaBackup && return Ptr{Cfloat}(x + 13112)
    f === :DisabledStackSize && return Ptr{Cshort}(x + 13116)
    f === :LockMarkEdited && return Ptr{Cshort}(x + 13118)
    f === :TooltipOverrideCount && return Ptr{Cshort}(x + 13120)
    f === :ClipboardHandlerData && return Ptr{ImVector_char}(x + 13128)
    f === :MenusIdSubmittedThisFrame && return Ptr{ImVector_ImGuiID}(x + 13144)
    f === :TypingSelectState && return Ptr{ImGuiTypingSelectState}(x + 13160)
    f === :PlatformImeData && return Ptr{ImGuiPlatformImeData}(x + 13264)
    f === :PlatformImeDataPrev && return Ptr{ImGuiPlatformImeData}(x + 13280)
    f === :PlatformImeViewport && return Ptr{ImGuiID}(x + 13296)
    f === :DockContext && return Ptr{ImGuiDockContext}(x + 13304)
    f === :DockNodeWindowMenuHandler && return Ptr{Ptr{Cvoid}}(x + 13360)
    f === :SettingsLoaded && return Ptr{Bool}(x + 13368)
    f === :SettingsDirtyTimer && return Ptr{Cfloat}(x + 13372)
    f === :SettingsIniData && return Ptr{ImGuiTextBuffer}(x + 13376)
    f === :SettingsHandlers && return Ptr{ImVector_ImGuiSettingsHandler}(x + 13392)
    f === :SettingsWindows && return Ptr{ImChunkStream_ImGuiWindowSettings}(x + 13408)
    f === :SettingsTables && return Ptr{ImChunkStream_ImGuiTableSettings}(x + 13424)
    f === :Hooks && return Ptr{ImVector_ImGuiContextHook}(x + 13440)
    f === :HookIdNext && return Ptr{ImGuiID}(x + 13456)
    f === :LocalizationTable && return Ptr{NTuple{11, Ptr{Cchar}}}(x + 13464)
    f === :LogEnabled && return Ptr{Bool}(x + 13552)
    f === :LogType && return Ptr{ImGuiLogType}(x + 13556)
    f === :LogFile && return Ptr{ImFileHandle}(x + 13560)
    f === :LogBuffer && return Ptr{ImGuiTextBuffer}(x + 13568)
    f === :LogNextPrefix && return Ptr{Ptr{Cchar}}(x + 13584)
    f === :LogNextSuffix && return Ptr{Ptr{Cchar}}(x + 13592)
    f === :LogLinePosY && return Ptr{Cfloat}(x + 13600)
    f === :LogLineFirstItem && return Ptr{Bool}(x + 13604)
    f === :LogDepthRef && return Ptr{Cint}(x + 13608)
    f === :LogDepthToExpand && return Ptr{Cint}(x + 13612)
    f === :LogDepthToExpandDefault && return Ptr{Cint}(x + 13616)
    f === :DebugLogFlags && return Ptr{ImGuiDebugLogFlags}(x + 13620)
    f === :DebugLogBuf && return Ptr{ImGuiTextBuffer}(x + 13624)
    f === :DebugLogIndex && return Ptr{ImGuiTextIndex}(x + 13640)
    f === :DebugLogAutoDisableFlags && return Ptr{ImGuiDebugLogFlags}(x + 13664)
    f === :DebugLogAutoDisableFrames && return Ptr{ImU8}(x + 13668)
    f === :DebugLocateFrames && return Ptr{ImU8}(x + 13669)
    f === :DebugBreakInLocateId && return Ptr{Bool}(x + 13670)
    f === :DebugBreakKeyChord && return Ptr{ImGuiKeyChord}(x + 13672)
    f === :DebugBeginReturnValueCullDepth && return Ptr{ImS8}(x + 13676)
    f === :DebugItemPickerActive && return Ptr{Bool}(x + 13677)
    f === :DebugItemPickerMouseButton && return Ptr{ImU8}(x + 13678)
    f === :DebugItemPickerBreakId && return Ptr{ImGuiID}(x + 13680)
    f === :DebugFlashStyleColorTime && return Ptr{Cfloat}(x + 13684)
    f === :DebugFlashStyleColorBackup && return Ptr{ImVec4}(x + 13688)
    f === :DebugMetricsConfig && return Ptr{ImGuiMetricsConfig}(x + 13704)
    f === :DebugIDStackTool && return Ptr{ImGuiIDStackTool}(x + 13736)
    f === :DebugAllocInfo && return Ptr{ImGuiDebugAllocInfo}(x + 13776)
    f === :DebugHoveredDockNode && return Ptr{Ptr{ImGuiDockNode}}(x + 13840)
    f === :FramerateSecPerFrame && return Ptr{NTuple{60, Cfloat}}(x + 13848)
    f === :FramerateSecPerFrameIdx && return Ptr{Cint}(x + 14088)
    f === :FramerateSecPerFrameCount && return Ptr{Cint}(x + 14092)
    f === :FramerateSecPerFrameAccum && return Ptr{Cfloat}(x + 14096)
    f === :WantCaptureMouseNextFrame && return Ptr{Cint}(x + 14100)
    f === :WantCaptureKeyboardNextFrame && return Ptr{Cint}(x + 14104)
    f === :WantTextInputNextFrame && return Ptr{Cint}(x + 14108)
    f === :TempBuffer && return Ptr{ImVector_char}(x + 14112)
    f === :TempKeychordName && return Ptr{NTuple{64, Cchar}}(x + 14128)
    error("Unrecognized field of type `ImGuiContext`" * ": $(f)")
end

function Base.getproperty(x::Ptr{ImGuiContext}, f::Symbol)
    f === :Initialized && return unsafe_load(getptr(x, f))
    f === :FontAtlasOwnedByContext && return unsafe_load(getptr(x, f))
    f === :IO && return getptr(x, f)
    f === :PlatformIO && return getptr(x, f)
    f === :Style && return getptr(x, f)
    f === :ConfigFlagsCurrFrame && return unsafe_load(getptr(x, f))
    f === :ConfigFlagsLastFrame && return unsafe_load(getptr(x, f))
    f === :Font && return unsafe_load(getptr(x, f))
    f === :FontSize && return unsafe_load(getptr(x, f))
    f === :FontBaseSize && return unsafe_load(getptr(x, f))
    f === :CurrentDpiScale && return unsafe_load(getptr(x, f))
    f === :DrawListSharedData && return getptr(x, f)
    f === :Time && return unsafe_load(getptr(x, f))
    f === :FrameCount && return unsafe_load(getptr(x, f))
    f === :FrameCountEnded && return unsafe_load(getptr(x, f))
    f === :FrameCountPlatformEnded && return unsafe_load(getptr(x, f))
    f === :FrameCountRendered && return unsafe_load(getptr(x, f))
    f === :WithinFrameScope && return unsafe_load(getptr(x, f))
    f === :WithinFrameScopeWithImplicitWindow && return unsafe_load(getptr(x, f))
    f === :WithinEndChild && return unsafe_load(getptr(x, f))
    f === :GcCompactAll && return unsafe_load(getptr(x, f))
    f === :TestEngineHookItems && return unsafe_load(getptr(x, f))
    f === :TestEngine && return unsafe_load(getptr(x, f))
    f === :InputEventsQueue && return getptr(x, f)
    f === :InputEventsTrail && return getptr(x, f)
    f === :InputEventsNextMouseSource && return unsafe_load(getptr(x, f))
    f === :InputEventsNextEventId && return unsafe_load(getptr(x, f))
    f === :Windows && return getptr(x, f)
    f === :WindowsFocusOrder && return getptr(x, f)
    f === :WindowsTempSortBuffer && return getptr(x, f)
    f === :CurrentWindowStack && return getptr(x, f)
    f === :WindowsById && return getptr(x, f)
    f === :WindowsActiveCount && return unsafe_load(getptr(x, f))
    f === :WindowsHoverPadding && return getptr(x, f)
    f === :DebugBreakInWindow && return unsafe_load(getptr(x, f))
    f === :CurrentWindow && return unsafe_load(getptr(x, f))
    f === :HoveredWindow && return unsafe_load(getptr(x, f))
    f === :HoveredWindowUnderMovingWindow && return unsafe_load(getptr(x, f))
    f === :MovingWindow && return unsafe_load(getptr(x, f))
    f === :WheelingWindow && return unsafe_load(getptr(x, f))
    f === :WheelingWindowRefMousePos && return getptr(x, f)
    f === :WheelingWindowStartFrame && return unsafe_load(getptr(x, f))
    f === :WheelingWindowScrolledFrame && return unsafe_load(getptr(x, f))
    f === :WheelingWindowReleaseTimer && return unsafe_load(getptr(x, f))
    f === :WheelingWindowWheelRemainder && return getptr(x, f)
    f === :WheelingAxisAvg && return getptr(x, f)
    f === :DebugHookIdInfo && return unsafe_load(getptr(x, f))
    f === :HoveredId && return unsafe_load(getptr(x, f))
    f === :HoveredIdPreviousFrame && return unsafe_load(getptr(x, f))
    f === :HoveredIdTimer && return unsafe_load(getptr(x, f))
    f === :HoveredIdNotActiveTimer && return unsafe_load(getptr(x, f))
    f === :HoveredIdAllowOverlap && return unsafe_load(getptr(x, f))
    f === :HoveredIdDisabled && return unsafe_load(getptr(x, f))
    f === :ItemUnclipByLog && return unsafe_load(getptr(x, f))
    f === :ActiveId && return unsafe_load(getptr(x, f))
    f === :ActiveIdIsAlive && return unsafe_load(getptr(x, f))
    f === :ActiveIdTimer && return unsafe_load(getptr(x, f))
    f === :ActiveIdIsJustActivated && return unsafe_load(getptr(x, f))
    f === :ActiveIdAllowOverlap && return unsafe_load(getptr(x, f))
    f === :ActiveIdNoClearOnFocusLoss && return unsafe_load(getptr(x, f))
    f === :ActiveIdHasBeenPressedBefore && return unsafe_load(getptr(x, f))
    f === :ActiveIdHasBeenEditedBefore && return unsafe_load(getptr(x, f))
    f === :ActiveIdHasBeenEditedThisFrame && return unsafe_load(getptr(x, f))
    f === :ActiveIdFromShortcut && return unsafe_load(getptr(x, f))
    f === :ActiveIdMouseButton && return getbitfieldproperty(x, getptr(x, f))
    f === :ActiveIdClickOffset && return getptr(x, f)
    f === :ActiveIdWindow && return unsafe_load(getptr(x, f))
    f === :ActiveIdSource && return unsafe_load(getptr(x, f))
    f === :ActiveIdPreviousFrame && return unsafe_load(getptr(x, f))
    f === :ActiveIdPreviousFrameIsAlive && return unsafe_load(getptr(x, f))
    f === :ActiveIdPreviousFrameHasBeenEditedBefore && return unsafe_load(getptr(x, f))
    f === :ActiveIdPreviousFrameWindow && return unsafe_load(getptr(x, f))
    f === :LastActiveId && return unsafe_load(getptr(x, f))
    f === :LastActiveIdTimer && return unsafe_load(getptr(x, f))
    f === :LastKeyModsChangeTime && return unsafe_load(getptr(x, f))
    f === :LastKeyModsChangeFromNoneTime && return unsafe_load(getptr(x, f))
    f === :LastKeyboardKeyPressTime && return unsafe_load(getptr(x, f))
    f === :KeysMayBeCharInput && return getptr(x, f)
    f === :KeysOwnerData && return getptr(x, f)
    f === :KeysRoutingTable && return getptr(x, f)
    f === :ActiveIdUsingNavDirMask && return unsafe_load(getptr(x, f))
    f === :ActiveIdUsingAllKeyboardKeys && return unsafe_load(getptr(x, f))
    f === :DebugBreakInShortcutRouting && return unsafe_load(getptr(x, f))
    f === :CurrentFocusScopeId && return unsafe_load(getptr(x, f))
    f === :CurrentItemFlags && return unsafe_load(getptr(x, f))
    f === :DebugLocateId && return unsafe_load(getptr(x, f))
    f === :NextItemData && return getptr(x, f)
    f === :LastItemData && return getptr(x, f)
    f === :NextWindowData && return getptr(x, f)
    f === :DebugShowGroupRects && return unsafe_load(getptr(x, f))
    f === :DebugFlashStyleColorIdx && return unsafe_load(getptr(x, f))
    f === :ColorStack && return getptr(x, f)
    f === :StyleVarStack && return getptr(x, f)
    f === :FontStack && return getptr(x, f)
    f === :FocusScopeStack && return getptr(x, f)
    f === :ItemFlagsStack && return getptr(x, f)
    f === :GroupStack && return getptr(x, f)
    f === :OpenPopupStack && return getptr(x, f)
    f === :BeginPopupStack && return getptr(x, f)
    f === :NavTreeNodeStack && return getptr(x, f)
    f === :Viewports && return getptr(x, f)
    f === :CurrentViewport && return unsafe_load(getptr(x, f))
    f === :MouseViewport && return unsafe_load(getptr(x, f))
    f === :MouseLastHoveredViewport && return unsafe_load(getptr(x, f))
    f === :PlatformLastFocusedViewportId && return unsafe_load(getptr(x, f))
    f === :FallbackMonitor && return getptr(x, f)
    f === :PlatformMonitorsFullWorkRect && return getptr(x, f)
    f === :ViewportCreatedCount && return unsafe_load(getptr(x, f))
    f === :PlatformWindowsCreatedCount && return unsafe_load(getptr(x, f))
    f === :ViewportFocusedStampCount && return unsafe_load(getptr(x, f))
    f === :NavWindow && return unsafe_load(getptr(x, f))
    f === :NavId && return unsafe_load(getptr(x, f))
    f === :NavFocusScopeId && return unsafe_load(getptr(x, f))
    f === :NavActivateId && return unsafe_load(getptr(x, f))
    f === :NavActivateDownId && return unsafe_load(getptr(x, f))
    f === :NavActivatePressedId && return unsafe_load(getptr(x, f))
    f === :NavActivateFlags && return unsafe_load(getptr(x, f))
    f === :NavFocusRoute && return getptr(x, f)
    f === :NavHighlightActivatedId && return unsafe_load(getptr(x, f))
    f === :NavHighlightActivatedTimer && return unsafe_load(getptr(x, f))
    f === :NavJustMovedToId && return unsafe_load(getptr(x, f))
    f === :NavJustMovedToFocusScopeId && return unsafe_load(getptr(x, f))
    f === :NavJustMovedToKeyMods && return unsafe_load(getptr(x, f))
    f === :NavNextActivateId && return unsafe_load(getptr(x, f))
    f === :NavNextActivateFlags && return unsafe_load(getptr(x, f))
    f === :NavInputSource && return unsafe_load(getptr(x, f))
    f === :NavLayer && return unsafe_load(getptr(x, f))
    f === :NavLastValidSelectionUserData && return unsafe_load(getptr(x, f))
    f === :NavIdIsAlive && return unsafe_load(getptr(x, f))
    f === :NavMousePosDirty && return unsafe_load(getptr(x, f))
    f === :NavDisableHighlight && return unsafe_load(getptr(x, f))
    f === :NavDisableMouseHover && return unsafe_load(getptr(x, f))
    f === :NavAnyRequest && return unsafe_load(getptr(x, f))
    f === :NavInitRequest && return unsafe_load(getptr(x, f))
    f === :NavInitRequestFromMove && return unsafe_load(getptr(x, f))
    f === :NavInitResult && return getptr(x, f)
    f === :NavMoveSubmitted && return unsafe_load(getptr(x, f))
    f === :NavMoveScoringItems && return unsafe_load(getptr(x, f))
    f === :NavMoveForwardToNextFrame && return unsafe_load(getptr(x, f))
    f === :NavMoveFlags && return unsafe_load(getptr(x, f))
    f === :NavMoveScrollFlags && return unsafe_load(getptr(x, f))
    f === :NavMoveKeyMods && return unsafe_load(getptr(x, f))
    f === :NavMoveDir && return unsafe_load(getptr(x, f))
    f === :NavMoveDirForDebug && return unsafe_load(getptr(x, f))
    f === :NavMoveClipDir && return unsafe_load(getptr(x, f))
    f === :NavScoringRect && return getptr(x, f)
    f === :NavScoringNoClipRect && return getptr(x, f)
    f === :NavScoringDebugCount && return unsafe_load(getptr(x, f))
    f === :NavTabbingDir && return unsafe_load(getptr(x, f))
    f === :NavTabbingCounter && return unsafe_load(getptr(x, f))
    f === :NavMoveResultLocal && return getptr(x, f)
    f === :NavMoveResultLocalVisible && return getptr(x, f)
    f === :NavMoveResultOther && return getptr(x, f)
    f === :NavTabbingResultFirst && return getptr(x, f)
    f === :ConfigNavWindowingKeyNext && return unsafe_load(getptr(x, f))
    f === :ConfigNavWindowingKeyPrev && return unsafe_load(getptr(x, f))
    f === :NavWindowingTarget && return unsafe_load(getptr(x, f))
    f === :NavWindowingTargetAnim && return unsafe_load(getptr(x, f))
    f === :NavWindowingListWindow && return unsafe_load(getptr(x, f))
    f === :NavWindowingTimer && return unsafe_load(getptr(x, f))
    f === :NavWindowingHighlightAlpha && return unsafe_load(getptr(x, f))
    f === :NavWindowingToggleLayer && return unsafe_load(getptr(x, f))
    f === :NavWindowingToggleKey && return unsafe_load(getptr(x, f))
    f === :NavWindowingAccumDeltaPos && return getptr(x, f)
    f === :NavWindowingAccumDeltaSize && return getptr(x, f)
    f === :DimBgRatio && return unsafe_load(getptr(x, f))
    f === :DragDropActive && return unsafe_load(getptr(x, f))
    f === :DragDropWithinSource && return unsafe_load(getptr(x, f))
    f === :DragDropWithinTarget && return unsafe_load(getptr(x, f))
    f === :DragDropSourceFlags && return unsafe_load(getptr(x, f))
    f === :DragDropSourceFrameCount && return unsafe_load(getptr(x, f))
    f === :DragDropMouseButton && return unsafe_load(getptr(x, f))
    f === :DragDropPayload && return getptr(x, f)
    f === :DragDropTargetRect && return getptr(x, f)
    f === :DragDropTargetClipRect && return getptr(x, f)
    f === :DragDropTargetId && return unsafe_load(getptr(x, f))
    f === :DragDropAcceptFlags && return unsafe_load(getptr(x, f))
    f === :DragDropAcceptIdCurrRectSurface && return unsafe_load(getptr(x, f))
    f === :DragDropAcceptIdCurr && return unsafe_load(getptr(x, f))
    f === :DragDropAcceptIdPrev && return unsafe_load(getptr(x, f))
    f === :DragDropAcceptFrameCount && return unsafe_load(getptr(x, f))
    f === :DragDropHoldJustPressedId && return unsafe_load(getptr(x, f))
    f === :DragDropPayloadBufHeap && return getptr(x, f)
    f === :DragDropPayloadBufLocal && return getptr(x, f)
    f === :ClipperTempDataStacked && return unsafe_load(getptr(x, f))
    f === :ClipperTempData && return getptr(x, f)
    f === :CurrentTable && return unsafe_load(getptr(x, f))
    f === :DebugBreakInTable && return unsafe_load(getptr(x, f))
    f === :TablesTempDataStacked && return unsafe_load(getptr(x, f))
    f === :TablesTempData && return getptr(x, f)
    f === :Tables && return getptr(x, f)
    f === :TablesLastTimeActive && return getptr(x, f)
    f === :DrawChannelsTempMergeBuffer && return getptr(x, f)
    f === :CurrentTabBar && return unsafe_load(getptr(x, f))
    f === :TabBars && return getptr(x, f)
    f === :CurrentTabBarStack && return getptr(x, f)
    f === :ShrinkWidthBuffer && return getptr(x, f)
    f === :HoverItemDelayId && return unsafe_load(getptr(x, f))
    f === :HoverItemDelayIdPreviousFrame && return unsafe_load(getptr(x, f))
    f === :HoverItemDelayTimer && return unsafe_load(getptr(x, f))
    f === :HoverItemDelayClearTimer && return unsafe_load(getptr(x, f))
    f === :HoverItemUnlockedStationaryId && return unsafe_load(getptr(x, f))
    f === :HoverWindowUnlockedStationaryId && return unsafe_load(getptr(x, f))
    f === :MouseCursor && return unsafe_load(getptr(x, f))
    f === :MouseStationaryTimer && return unsafe_load(getptr(x, f))
    f === :MouseLastValidPos && return getptr(x, f)
    f === :InputTextState && return getptr(x, f)
    f === :InputTextDeactivatedState && return getptr(x, f)
    f === :InputTextPasswordFont && return getptr(x, f)
    f === :TempInputId && return unsafe_load(getptr(x, f))
    f === :DataTypeZeroValue && return getptr(x, f)
    f === :BeginMenuDepth && return unsafe_load(getptr(x, f))
    f === :BeginComboDepth && return unsafe_load(getptr(x, f))
    f === :ColorEditOptions && return unsafe_load(getptr(x, f))
    f === :ColorEditCurrentID && return unsafe_load(getptr(x, f))
    f === :ColorEditSavedID && return unsafe_load(getptr(x, f))
    f === :ColorEditSavedHue && return unsafe_load(getptr(x, f))
    f === :ColorEditSavedSat && return unsafe_load(getptr(x, f))
    f === :ColorEditSavedColor && return unsafe_load(getptr(x, f))
    f === :ColorPickerRef && return getptr(x, f)
    f === :ComboPreviewData && return getptr(x, f)
    f === :WindowResizeBorderExpectedRect && return getptr(x, f)
    f === :WindowResizeRelativeMode && return unsafe_load(getptr(x, f))
    f === :ScrollbarSeekMode && return unsafe_load(getptr(x, f))
    f === :ScrollbarClickDeltaToGrabCenter && return unsafe_load(getptr(x, f))
    f === :SliderGrabClickOffset && return unsafe_load(getptr(x, f))
    f === :SliderCurrentAccum && return unsafe_load(getptr(x, f))
    f === :SliderCurrentAccumDirty && return unsafe_load(getptr(x, f))
    f === :DragCurrentAccumDirty && return unsafe_load(getptr(x, f))
    f === :DragCurrentAccum && return unsafe_load(getptr(x, f))
    f === :DragSpeedDefaultRatio && return unsafe_load(getptr(x, f))
    f === :DisabledAlphaBackup && return unsafe_load(getptr(x, f))
    f === :DisabledStackSize && return unsafe_load(getptr(x, f))
    f === :LockMarkEdited && return unsafe_load(getptr(x, f))
    f === :TooltipOverrideCount && return unsafe_load(getptr(x, f))
    f === :ClipboardHandlerData && return getptr(x, f)
    f === :MenusIdSubmittedThisFrame && return getptr(x, f)
    f === :TypingSelectState && return getptr(x, f)
    f === :PlatformImeData && return getptr(x, f)
    f === :PlatformImeDataPrev && return getptr(x, f)
    f === :PlatformImeViewport && return unsafe_load(getptr(x, f))
    f === :DockContext && return getptr(x, f)
    f === :DockNodeWindowMenuHandler && return unsafe_load(getptr(x, f))
    f === :SettingsLoaded && return unsafe_load(getptr(x, f))
    f === :SettingsDirtyTimer && return unsafe_load(getptr(x, f))
    f === :SettingsIniData && return getptr(x, f)
    f === :SettingsHandlers && return getptr(x, f)
    f === :SettingsWindows && return getptr(x, f)
    f === :SettingsTables && return getptr(x, f)
    f === :Hooks && return getptr(x, f)
    f === :HookIdNext && return unsafe_load(getptr(x, f))
    f === :LocalizationTable && return getptr(x, f)
    f === :LogEnabled && return unsafe_load(getptr(x, f))
    f === :LogType && return unsafe_load(getptr(x, f))
    f === :LogFile && return unsafe_load(getptr(x, f))
    f === :LogBuffer && return getptr(x, f)
    f === :LogNextPrefix && return unsafe_load(getptr(x, f))
    f === :LogNextSuffix && return unsafe_load(getptr(x, f))
    f === :LogLinePosY && return unsafe_load(getptr(x, f))
    f === :LogLineFirstItem && return unsafe_load(getptr(x, f))
    f === :LogDepthRef && return unsafe_load(getptr(x, f))
    f === :LogDepthToExpand && return unsafe_load(getptr(x, f))
    f === :LogDepthToExpandDefault && return unsafe_load(getptr(x, f))
    f === :DebugLogFlags && return unsafe_load(getptr(x, f))
    f === :DebugLogBuf && return getptr(x, f)
    f === :DebugLogIndex && return getptr(x, f)
    f === :DebugLogAutoDisableFlags && return unsafe_load(getptr(x, f))
    f === :DebugLogAutoDisableFrames && return unsafe_load(getptr(x, f))
    f === :DebugLocateFrames && return unsafe_load(getptr(x, f))
    f === :DebugBreakInLocateId && return unsafe_load(getptr(x, f))
    f === :DebugBreakKeyChord && return unsafe_load(getptr(x, f))
    f === :DebugBeginReturnValueCullDepth && return unsafe_load(getptr(x, f))
    f === :DebugItemPickerActive && return unsafe_load(getptr(x, f))
    f === :DebugItemPickerMouseButton && return unsafe_load(getptr(x, f))
    f === :DebugItemPickerBreakId && return unsafe_load(getptr(x, f))
    f === :DebugFlashStyleColorTime && return unsafe_load(getptr(x, f))
    f === :DebugFlashStyleColorBackup && return getptr(x, f)
    f === :DebugMetricsConfig && return getptr(x, f)
    f === :DebugIDStackTool && return getptr(x, f)
    f === :DebugAllocInfo && return getptr(x, f)
    f === :DebugHoveredDockNode && return unsafe_load(getptr(x, f))
    f === :FramerateSecPerFrame && return getptr(x, f)
    f === :FramerateSecPerFrameIdx && return unsafe_load(getptr(x, f))
    f === :FramerateSecPerFrameCount && return unsafe_load(getptr(x, f))
    f === :FramerateSecPerFrameAccum && return unsafe_load(getptr(x, f))
    f === :WantCaptureMouseNextFrame && return unsafe_load(getptr(x, f))
    f === :WantCaptureKeyboardNextFrame && return unsafe_load(getptr(x, f))
    f === :WantTextInputNextFrame && return unsafe_load(getptr(x, f))
    f === :TempBuffer && return getptr(x, f)
    f === :TempKeychordName && return getptr(x, f)
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImGuiSizeCallbackData}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImGuiSizeCallbackData}, f::Symbol)
    f === :UserData && return unsafe_load(getptr(x, f))
    f === :Pos && return getptr(x, f)
    f === :CurrentSize && return getptr(x, f)
    f === :DesiredSize && return getptr(x, f)
    return getfield(x, f)
end
...
function getptr(x::Ptr{ImGuiTableColumnSettings}, f::Symbol)
...
function Base.getproperty(x::Ptr{ImGuiTableColumnSettings}, f::Symbol)
    f === :WidthOrWeight && return unsafe_load(getptr(x, f))
    f === :UserID && return unsafe_load(getptr(x, f))
    f === :Index && return unsafe_load(getptr(x, f))
    f === :DisplayOrder && return unsafe_load(getptr(x, f))
    f === :SortOrder && return unsafe_load(getptr(x, f))
    f === :SortDirection && return getbitfieldproperty(x, getptr(x, f))
    f === :IsEnabled && return getbitfieldproperty(x, getptr(x, f))
    f === :IsStretch && return getbitfieldproperty(x, getptr(x, f))
    return getfield(x, f)
end
