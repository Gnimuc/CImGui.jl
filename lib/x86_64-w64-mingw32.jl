...
function Base.getproperty(x::Ptr{ImGuiContext}, f::Symbol)
    ...
    f === :ActiveIdMouseButton && return (Ptr{Cint}(x + 5352), 0, 8)
    f === :ActiveIdClickOffset && return Ptr{ImVec2}(x + 5356)
    f === :ActiveIdWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5368)
    f === :ActiveIdSource && return Ptr{ImGuiInputSource}(x + 5376)
    f === :ActiveIdPreviousFrame && return Ptr{ImGuiID}(x + 5380)
    f === :ActiveIdPreviousFrameIsAlive && return Ptr{Bool}(x + 5384)
    f === :ActiveIdPreviousFrameHasBeenEditedBefore && return Ptr{Bool}(x + 5385)
    f === :ActiveIdPreviousFrameWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5392)
    f === :LastActiveId && return Ptr{ImGuiID}(x + 5400)
    f === :LastActiveIdTimer && return Ptr{Cfloat}(x + 5404)
    f === :LastKeyModsChangeTime && return Ptr{Cdouble}(x + 5408)
    f === :LastKeyModsChangeFromNoneTime && return Ptr{Cdouble}(x + 5416)
    f === :LastKeyboardKeyPressTime && return Ptr{Cdouble}(x + 5424)
    f === :KeysMayBeCharInput && return Ptr{ImBitArrayForNamedKeys}(x + 5432)
    f === :KeysOwnerData && return Ptr{NTuple{154, ImGuiKeyOwnerData}}(x + 5452)
    f === :KeysRoutingTable && return Ptr{ImGuiKeyRoutingTable}(x + 7304)
    f === :ActiveIdUsingNavDirMask && return Ptr{ImU32}(x + 7648)
    f === :ActiveIdUsingAllKeyboardKeys && return Ptr{Bool}(x + 7652)
    f === :DebugBreakInShortcutRouting && return Ptr{ImGuiKeyChord}(x + 7656)
    f === :CurrentFocusScopeId && return Ptr{ImGuiID}(x + 7660)
    f === :CurrentItemFlags && return Ptr{ImGuiItemFlags}(x + 7664)
    f === :DebugLocateId && return Ptr{ImGuiID}(x + 7668)
    f === :NextItemData && return Ptr{ImGuiNextItemData}(x + 7672)
    f === :LastItemData && return Ptr{ImGuiLastItemData}(x + 7728)
    f === :NextWindowData && return Ptr{ImGuiNextWindowData}(x + 7808)
    f === :DebugShowGroupRects && return Ptr{Bool}(x + 7968)
    f === :DebugFlashStyleColorIdx && return Ptr{ImGuiCol}(x + 7972)
    f === :ColorStack && return Ptr{ImVector_ImGuiColorMod}(x + 7976)
    f === :StyleVarStack && return Ptr{ImVector_ImGuiStyleMod}(x + 7992)
    f === :FontStack && return Ptr{ImVector_ImFontPtr}(x + 8008)
    f === :FocusScopeStack && return Ptr{ImVector_ImGuiFocusScopeData}(x + 8024)
    f === :ItemFlagsStack && return Ptr{ImVector_ImGuiItemFlags}(x + 8040)
    f === :GroupStack && return Ptr{ImVector_ImGuiGroupData}(x + 8056)
    f === :OpenPopupStack && return Ptr{ImVector_ImGuiPopupData}(x + 8072)
    f === :BeginPopupStack && return Ptr{ImVector_ImGuiPopupData}(x + 8088)
    f === :TreeNodeStack && return Ptr{ImVector_ImGuiTreeNodeStackData}(x + 8104)
    f === :Viewports && return Ptr{ImVector_ImGuiViewportPPtr}(x + 8120)
    f === :CurrentViewport && return Ptr{Ptr{ImGuiViewportP}}(x + 8136)
    f === :MouseViewport && return Ptr{Ptr{ImGuiViewportP}}(x + 8144)
    f === :MouseLastHoveredViewport && return Ptr{Ptr{ImGuiViewportP}}(x + 8152)
    f === :PlatformLastFocusedViewportId && return Ptr{ImGuiID}(x + 8160)
    f === :FallbackMonitor && return Ptr{ImGuiPlatformMonitor}(x + 8168)
    f === :PlatformMonitorsFullWorkRect && return Ptr{ImRect}(x + 8216)
    f === :ViewportCreatedCount && return Ptr{Cint}(x + 8232)
    f === :PlatformWindowsCreatedCount && return Ptr{Cint}(x + 8236)
    f === :ViewportFocusedStampCount && return Ptr{Cint}(x + 8240)
    f === :NavWindow && return Ptr{Ptr{ImGuiWindow}}(x + 8248)
    f === :NavId && return Ptr{ImGuiID}(x + 8256)
    f === :NavFocusScopeId && return Ptr{ImGuiID}(x + 8260)
    f === :NavLayer && return Ptr{ImGuiNavLayer}(x + 8264)
    f === :NavActivateId && return Ptr{ImGuiID}(x + 8268)
    f === :NavActivateDownId && return Ptr{ImGuiID}(x + 8272)
    f === :NavActivatePressedId && return Ptr{ImGuiID}(x + 8276)
    f === :NavActivateFlags && return Ptr{ImGuiActivateFlags}(x + 8280)
    f === :NavFocusRoute && return Ptr{ImVector_ImGuiFocusScopeData}(x + 8288)
    f === :NavHighlightActivatedId && return Ptr{ImGuiID}(x + 8304)
    f === :NavHighlightActivatedTimer && return Ptr{Cfloat}(x + 8308)
    f === :NavNextActivateId && return Ptr{ImGuiID}(x + 8312)
    f === :NavNextActivateFlags && return Ptr{ImGuiActivateFlags}(x + 8316)
    f === :NavInputSource && return Ptr{ImGuiInputSource}(x + 8320)
    f === :NavLastValidSelectionUserData && return Ptr{ImGuiSelectionUserData}(x + 8328)
    f === :NavIdIsAlive && return Ptr{Bool}(x + 8336)
    f === :NavMousePosDirty && return Ptr{Bool}(x + 8337)
    f === :NavDisableHighlight && return Ptr{Bool}(x + 8338)
    f === :NavDisableMouseHover && return Ptr{Bool}(x + 8339)
    f === :NavAnyRequest && return Ptr{Bool}(x + 8340)
    f === :NavInitRequest && return Ptr{Bool}(x + 8341)
    f === :NavInitRequestFromMove && return Ptr{Bool}(x + 8342)
    f === :NavInitResult && return Ptr{ImGuiNavItemData}(x + 8344)
    f === :NavMoveSubmitted && return Ptr{Bool}(x + 8400)
    f === :NavMoveScoringItems && return Ptr{Bool}(x + 8401)
    f === :NavMoveForwardToNextFrame && return Ptr{Bool}(x + 8402)
    f === :NavMoveFlags && return Ptr{ImGuiNavMoveFlags}(x + 8404)
    f === :NavMoveScrollFlags && return Ptr{ImGuiScrollFlags}(x + 8408)
    f === :NavMoveKeyMods && return Ptr{ImGuiKeyChord}(x + 8412)
    f === :NavMoveDir && return Ptr{ImGuiDir}(x + 8416)
    f === :NavMoveDirForDebug && return Ptr{ImGuiDir}(x + 8420)
    f === :NavMoveClipDir && return Ptr{ImGuiDir}(x + 8424)
    f === :NavScoringRect && return Ptr{ImRect}(x + 8428)
    f === :NavScoringNoClipRect && return Ptr{ImRect}(x + 8444)
    f === :NavScoringDebugCount && return Ptr{Cint}(x + 8460)
    f === :NavTabbingDir && return Ptr{Cint}(x + 8464)
    f === :NavTabbingCounter && return Ptr{Cint}(x + 8468)
    f === :NavMoveResultLocal && return Ptr{ImGuiNavItemData}(x + 8472)
    f === :NavMoveResultLocalVisible && return Ptr{ImGuiNavItemData}(x + 8528)
    f === :NavMoveResultOther && return Ptr{ImGuiNavItemData}(x + 8584)
    f === :NavTabbingResultFirst && return Ptr{ImGuiNavItemData}(x + 8640)
    f === :NavJustMovedFromFocusScopeId && return Ptr{ImGuiID}(x + 8696)
    f === :NavJustMovedToId && return Ptr{ImGuiID}(x + 8700)
    f === :NavJustMovedToFocusScopeId && return Ptr{ImGuiID}(x + 8704)
    f === :NavJustMovedToKeyMods && return Ptr{ImGuiKeyChord}(x + 8708)
    f === :NavJustMovedToIsTabbing && return Ptr{Bool}(x + 8712)
    f === :NavJustMovedToHasSelectionData && return Ptr{Bool}(x + 8713)
    f === :ConfigNavWindowingKeyNext && return Ptr{ImGuiKeyChord}(x + 8716)
    f === :ConfigNavWindowingKeyPrev && return Ptr{ImGuiKeyChord}(x + 8720)
    f === :NavWindowingTarget && return Ptr{Ptr{ImGuiWindow}}(x + 8728)
    f === :NavWindowingTargetAnim && return Ptr{Ptr{ImGuiWindow}}(x + 8736)
    f === :NavWindowingListWindow && return Ptr{Ptr{ImGuiWindow}}(x + 8744)
    f === :NavWindowingTimer && return Ptr{Cfloat}(x + 8752)
    f === :NavWindowingHighlightAlpha && return Ptr{Cfloat}(x + 8756)
    f === :NavWindowingToggleLayer && return Ptr{Bool}(x + 8760)
    f === :NavWindowingToggleKey && return Ptr{ImGuiKey}(x + 8764)
    f === :NavWindowingAccumDeltaPos && return Ptr{ImVec2}(x + 8768)
    f === :NavWindowingAccumDeltaSize && return Ptr{ImVec2}(x + 8776)
    f === :DimBgRatio && return Ptr{Cfloat}(x + 8784)
    f === :DragDropActive && return Ptr{Bool}(x + 8788)
    f === :DragDropWithinSource && return Ptr{Bool}(x + 8789)
    f === :DragDropWithinTarget && return Ptr{Bool}(x + 8790)
    f === :DragDropSourceFlags && return Ptr{ImGuiDragDropFlags}(x + 8792)
    f === :DragDropSourceFrameCount && return Ptr{Cint}(x + 8796)
    f === :DragDropMouseButton && return Ptr{Cint}(x + 8800)
    f === :DragDropPayload && return Ptr{ImGuiPayload}(x + 8808)
    f === :DragDropTargetRect && return Ptr{ImRect}(x + 8872)
    f === :DragDropTargetClipRect && return Ptr{ImRect}(x + 8888)
    f === :DragDropTargetId && return Ptr{ImGuiID}(x + 8904)
    f === :DragDropAcceptFlags && return Ptr{ImGuiDragDropFlags}(x + 8908)
    f === :DragDropAcceptIdCurrRectSurface && return Ptr{Cfloat}(x + 8912)
    f === :DragDropAcceptIdCurr && return Ptr{ImGuiID}(x + 8916)
    f === :DragDropAcceptIdPrev && return Ptr{ImGuiID}(x + 8920)
    f === :DragDropAcceptFrameCount && return Ptr{Cint}(x + 8924)
    f === :DragDropHoldJustPressedId && return Ptr{ImGuiID}(x + 8928)
    f === :DragDropPayloadBufHeap && return Ptr{ImVector_unsigned_char}(x + 8936)
    f === :DragDropPayloadBufLocal && return Ptr{NTuple{16, Cuchar}}(x + 8952)
    f === :ClipperTempDataStacked && return Ptr{Cint}(x + 8968)
    f === :ClipperTempData && return Ptr{ImVector_ImGuiListClipperData}(x + 8976)
    f === :CurrentTable && return Ptr{Ptr{ImGuiTable}}(x + 8992)
    f === :DebugBreakInTable && return Ptr{ImGuiID}(x + 9000)
    f === :TablesTempDataStacked && return Ptr{Cint}(x + 9004)
    f === :TablesTempData && return Ptr{ImVector_ImGuiTableTempData}(x + 9008)
    f === :Tables && return Ptr{ImPool_ImGuiTable}(x + 9024)
    f === :TablesLastTimeActive && return Ptr{ImVector_float}(x + 9064)
    f === :DrawChannelsTempMergeBuffer && return Ptr{ImVector_ImDrawChannel}(x + 9080)
    f === :CurrentTabBar && return Ptr{Ptr{ImGuiTabBar}}(x + 9096)
    f === :TabBars && return Ptr{ImPool_ImGuiTabBar}(x + 9104)
    f === :CurrentTabBarStack && return Ptr{ImVector_ImGuiPtrOrIndex}(x + 9144)
    f === :ShrinkWidthBuffer && return Ptr{ImVector_ImGuiShrinkWidthItem}(x + 9160)
    f === :BoxSelectState && return Ptr{ImGuiBoxSelectState}(x + 9176)
    f === :CurrentMultiSelect && return Ptr{Ptr{ImGuiMultiSelectTempData}}(x + 9280)
    f === :MultiSelectTempDataStacked && return Ptr{Cint}(x + 9288)
    f === :MultiSelectTempData && return Ptr{ImVector_ImGuiMultiSelectTempData}(x + 9296)
    f === :MultiSelectStorage && return Ptr{ImPool_ImGuiMultiSelectState}(x + 9312)
    f === :HoverItemDelayId && return Ptr{ImGuiID}(x + 9352)
    f === :HoverItemDelayIdPreviousFrame && return Ptr{ImGuiID}(x + 9356)
    f === :HoverItemDelayTimer && return Ptr{Cfloat}(x + 9360)
    f === :HoverItemDelayClearTimer && return Ptr{Cfloat}(x + 9364)
    f === :HoverItemUnlockedStationaryId && return Ptr{ImGuiID}(x + 9368)
    f === :HoverWindowUnlockedStationaryId && return Ptr{ImGuiID}(x + 9372)
    f === :MouseCursor && return Ptr{ImGuiMouseCursor}(x + 9376)
    f === :MouseStationaryTimer && return Ptr{Cfloat}(x + 9380)
    f === :MouseLastValidPos && return Ptr{ImVec2}(x + 9384)
    f === :InputTextState && return Ptr{ImGuiInputTextState}(x + 9392)
    f === :InputTextDeactivatedState && return Ptr{ImGuiInputTextDeactivatedState}(x + 13128)
    f === :InputTextPasswordFont && return Ptr{ImFont}(x + 13152)
    f === :TempInputId && return Ptr{ImGuiID}(x + 13272)
    f === :DataTypeZeroValue && return Ptr{ImGuiDataTypeStorage}(x + 13276)
    f === :BeginMenuDepth && return Ptr{Cint}(x + 13284)
    f === :BeginComboDepth && return Ptr{Cint}(x + 13288)
    f === :ColorEditOptions && return Ptr{ImGuiColorEditFlags}(x + 13292)
    f === :ColorEditCurrentID && return Ptr{ImGuiID}(x + 13296)
    f === :ColorEditSavedID && return Ptr{ImGuiID}(x + 13300)
    f === :ColorEditSavedHue && return Ptr{Cfloat}(x + 13304)
    f === :ColorEditSavedSat && return Ptr{Cfloat}(x + 13308)
    f === :ColorEditSavedColor && return Ptr{ImU32}(x + 13312)
    f === :ColorPickerRef && return Ptr{ImVec4}(x + 13316)
    f === :ComboPreviewData && return Ptr{ImGuiComboPreviewData}(x + 13332)
    f === :WindowResizeBorderExpectedRect && return Ptr{ImRect}(x + 13380)
    f === :WindowResizeRelativeMode && return Ptr{Bool}(x + 13396)
    f === :ScrollbarSeekMode && return Ptr{Cshort}(x + 13398)
    f === :ScrollbarClickDeltaToGrabCenter && return Ptr{Cfloat}(x + 13400)
    f === :SliderGrabClickOffset && return Ptr{Cfloat}(x + 13404)
    f === :SliderCurrentAccum && return Ptr{Cfloat}(x + 13408)
    f === :SliderCurrentAccumDirty && return Ptr{Bool}(x + 13412)
    f === :DragCurrentAccumDirty && return Ptr{Bool}(x + 13413)
    f === :DragCurrentAccum && return Ptr{Cfloat}(x + 13416)
    f === :DragSpeedDefaultRatio && return Ptr{Cfloat}(x + 13420)
    f === :DisabledAlphaBackup && return Ptr{Cfloat}(x + 13424)
    f === :DisabledStackSize && return Ptr{Cshort}(x + 13428)
    f === :LockMarkEdited && return Ptr{Cshort}(x + 13430)
    f === :TooltipOverrideCount && return Ptr{Cshort}(x + 13432)
    f === :ClipboardHandlerData && return Ptr{ImVector_char}(x + 13440)
    f === :MenusIdSubmittedThisFrame && return Ptr{ImVector_ImGuiID}(x + 13456)
    f === :TypingSelectState && return Ptr{ImGuiTypingSelectState}(x + 13472)
    f === :PlatformImeData && return Ptr{ImGuiPlatformImeData}(x + 13576)
    f === :PlatformImeDataPrev && return Ptr{ImGuiPlatformImeData}(x + 13592)
    f === :PlatformImeViewport && return Ptr{ImGuiID}(x + 13608)
    f === :DockContext && return Ptr{ImGuiDockContext}(x + 13616)
    f === :DockNodeWindowMenuHandler && return Ptr{Ptr{Cvoid}}(x + 13672)
    f === :SettingsLoaded && return Ptr{Bool}(x + 13680)
    f === :SettingsDirtyTimer && return Ptr{Cfloat}(x + 13684)
    f === :SettingsIniData && return Ptr{ImGuiTextBuffer}(x + 13688)
    f === :SettingsHandlers && return Ptr{ImVector_ImGuiSettingsHandler}(x + 13704)
    f === :SettingsWindows && return Ptr{ImChunkStream_ImGuiWindowSettings}(x + 13720)
    f === :SettingsTables && return Ptr{ImChunkStream_ImGuiTableSettings}(x + 13736)
    f === :Hooks && return Ptr{ImVector_ImGuiContextHook}(x + 13752)
    f === :HookIdNext && return Ptr{ImGuiID}(x + 13768)
    f === :LocalizationTable && return Ptr{NTuple{12, Ptr{Cchar}}}(x + 13776)
    f === :LogEnabled && return Ptr{Bool}(x + 13872)
    f === :LogType && return Ptr{ImGuiLogType}(x + 13876)
    f === :LogFile && return Ptr{ImFileHandle}(x + 13880)
    f === :LogBuffer && return Ptr{ImGuiTextBuffer}(x + 13888)
    f === :LogNextPrefix && return Ptr{Ptr{Cchar}}(x + 13904)
    f === :LogNextSuffix && return Ptr{Ptr{Cchar}}(x + 13912)
    f === :LogLinePosY && return Ptr{Cfloat}(x + 13920)
    f === :LogLineFirstItem && return Ptr{Bool}(x + 13924)
    f === :LogDepthRef && return Ptr{Cint}(x + 13928)
    f === :LogDepthToExpand && return Ptr{Cint}(x + 13932)
    f === :LogDepthToExpandDefault && return Ptr{Cint}(x + 13936)
    f === :DebugLogFlags && return Ptr{ImGuiDebugLogFlags}(x + 13940)
    f === :DebugLogBuf && return Ptr{ImGuiTextBuffer}(x + 13944)
    f === :DebugLogIndex && return Ptr{ImGuiTextIndex}(x + 13960)
    f === :DebugLogAutoDisableFlags && return Ptr{ImGuiDebugLogFlags}(x + 13984)
    f === :DebugLogAutoDisableFrames && return Ptr{ImU8}(x + 13988)
    f === :DebugLocateFrames && return Ptr{ImU8}(x + 13989)
    f === :DebugBreakInLocateId && return Ptr{Bool}(x + 13990)
    f === :DebugBreakKeyChord && return Ptr{ImGuiKeyChord}(x + 13992)
    f === :DebugBeginReturnValueCullDepth && return Ptr{ImS8}(x + 13996)
    f === :DebugItemPickerActive && return Ptr{Bool}(x + 13997)
    f === :DebugItemPickerMouseButton && return Ptr{ImU8}(x + 13998)
    f === :DebugItemPickerBreakId && return Ptr{ImGuiID}(x + 14000)
    f === :DebugFlashStyleColorTime && return Ptr{Cfloat}(x + 14004)
    f === :DebugFlashStyleColorBackup && return Ptr{ImVec4}(x + 14008)
    f === :DebugMetricsConfig && return Ptr{ImGuiMetricsConfig}(x + 14024)
    f === :DebugIDStackTool && return Ptr{ImGuiIDStackTool}(x + 14056)
    f === :DebugAllocInfo && return Ptr{ImGuiDebugAllocInfo}(x + 14096)
    f === :DebugHoveredDockNode && return Ptr{Ptr{ImGuiDockNode}}(x + 14160)
    f === :FramerateSecPerFrame && return Ptr{NTuple{60, Cfloat}}(x + 14168)
    f === :FramerateSecPerFrameIdx && return Ptr{Cint}(x + 14408)
    f === :FramerateSecPerFrameCount && return Ptr{Cint}(x + 14412)
    f === :FramerateSecPerFrameAccum && return Ptr{Cfloat}(x + 14416)
    f === :WantCaptureMouseNextFrame && return Ptr{Cint}(x + 14420)
    f === :WantCaptureKeyboardNextFrame && return Ptr{Cint}(x + 14424)
    f === :WantTextInputNextFrame && return Ptr{Cint}(x + 14428)
    f === :TempBuffer && return Ptr{ImVector_char}(x + 14432)
    f === :TempKeychordName && return Ptr{NTuple{64, Cchar}}(x + 14448)
    return getfield(x, f)
end
