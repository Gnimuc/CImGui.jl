...
function ImGuiIO_Get_IniFilename(io)
    ccall((:ImGuiIO_Get_IniFilename, libcimgui_helper), Ptr{Cchar}, (Ptr{ImGuiIO},), io)
end

function ImGuiIO_Get_LogFilename(io)
    ccall((:ImGuiIO_Get_LogFilename, libcimgui_helper), Ptr{Cchar}, (Ptr{ImGuiIO},), io)
end
...
function ImGuiIO_Get_BackendPlatformName(io)
    ccall((:ImGuiIO_Get_BackendPlatformName, libcimgui_helper), Ptr{Cchar}, (Ptr{ImGuiIO},), io)
end

function ImGuiIO_Get_BackendRendererName(io)
    ccall((:ImGuiIO_Get_BackendRendererName, libcimgui_helper), Ptr{Cchar}, (Ptr{ImGuiIO},), io)
end
...
function ImGuiIO_Set_IniFilename(io, x)
    ccall((:ImGuiIO_Set_IniFilename, libcimgui_helper), Cvoid, (Ptr{ImGuiIO}, Ptr{Cchar}), io, x)
end

function ImGuiIO_Set_LogFilename(io, x)
    ccall((:ImGuiIO_Set_LogFilename, libcimgui_helper), Cvoid, (Ptr{ImGuiIO}, Ptr{Cchar}), io, x)
end
...
function ImGuiIO_Set_BackendPlatformName(io, x)
    ccall((:ImGuiIO_Set_BackendPlatformName, libcimgui_helper), Cvoid, (Ptr{ImGuiIO}, Ptr{Cchar}), io, x)
end

function ImGuiIO_Set_BackendRendererName(io, x)
    ccall((:ImGuiIO_Set_BackendRendererName, libcimgui_helper), Cvoid, (Ptr{ImGuiIO}, Ptr{Cchar}), io, x)
end
...
function ImDrawCmd_Get_ElemCount(cmd)
    ccall((:ImDrawCmd_Get_ElemCount, libcimgui_helper), Cuint, (Ptr{ImDrawCmd},), cmd)
end
...
function ImDrawCmd_Get_VtxOffset(cmd)
    ccall((:ImDrawCmd_Get_VtxOffset, libcimgui_helper), Cuint, (Ptr{ImDrawCmd},), cmd)
end

function ImDrawCmd_Get_IdxOffset(cmd)
    ccall((:ImDrawCmd_Get_IdxOffset, libcimgui_helper), Cuint, (Ptr{ImDrawCmd},), cmd)
end
...
function ImFontAtlas_Get_TexPixelsRGBA32(f)
    ccall((:ImFontAtlas_Get_TexPixelsRGBA32, libcimgui_helper), Ptr{Cuint}, (Ptr{ImFontAtlas},), f)
end
...
const CIMGUI_HELPER = nothing

const CIMGUI_DEFINE_ENUMS_AND_STRUCTS = nothing
