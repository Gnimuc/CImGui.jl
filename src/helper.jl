...
function Base.getproperty(io::Ptr{ImGuiIO}, x::Symbol)
    ...
    x == :DisplayVisibleMin && return ImGuiIO_Get_DisplayVisibleMin(io)
    x == :DisplayVisibleMax && return ImGuiIO_Get_DisplayVisibleMax(io)
    ...
    x == :ConfigResizeWindowsFromEdges && return ImGuiIO_Get_ConfigResizeWindowsFromEdges(io)
    ...
    x == :RenderDrawListsFnUnused && return ImGuiIO_Get_RenderDrawListsFnUnused(io)
...
function Base.setproperty!(io::Ptr{ImGuiIO}, x::Symbol, v)
    ...
    x == :DisplayVisibleMin && return ImGuiIO_Set_DisplayVisibleMin(io, v)
    x == :DisplayVisibleMax && return ImGuiIO_Set_DisplayVisibleMax(io, v)
    ...
    x == :ConfigResizeWindowsFromEdges && return ImGuiIO_Set_ConfigResizeWindowsFromEdges(io, v)
    ...
    x == :RenderDrawListsFnUnused && return ImGuiIO_Set_RenderDrawListsFnUnused(io, v)
    ...
    x == :WantCaptureMouse && return ImGuiIO_Set_WantCaptureMouse(io, v)
    x == :WantCaptureKeyboard && return ImGuiIO_Set_WantCaptureKeyboard(io, v)
    x == :WantTextInput && return ImGuiIO_Set_WantTextInput(io, v)
    x == :WantSetMousePos && return ImGuiIO_Set_WantSetMousePos(io, v)
    x == :WantSaveIniSettings && return ImGuiIO_Set_WantSaveIniSettings(io, v)
    x == :NavActive && return ImGuiIO_Set_NavActive(io, v)
    x == :NavVisible && return ImGuiIO_Set_NavVisible(io, v)
    x == :Framerate && return ImGuiIO_Set_Framerate(io, v)
    x == :MetricsRenderVertices && return ImGuiIO_Set_MetricsRenderVertices(io, v)
    x == :MetricsRenderIndices && return ImGuiIO_Set_MetricsRenderIndices(io, v)
    x == :MetricsRenderWindows && return ImGuiIO_Set_MetricsRenderWindows(io, v)
    x == :MetricsActiveWindows && return ImGuiIO_Set_MetricsActiveWindows(io, v)
    x == :MetricsActiveAllocations && return ImGuiIO_Set_MetricsActiveAllocations(io, v)
    x == :MouseDelta && return ImGuiIO_Set_MouseDelta(io, v)
    x == :MousePosPrev && return ImGuiIO_Set_MousePosPrev(io, v)
    throw(ArgumentError("field $x is not supported to be used like this, please use `Set_$x` instead."))
end
